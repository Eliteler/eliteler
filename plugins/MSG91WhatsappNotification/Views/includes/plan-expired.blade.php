                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select user_remainder" name="user_plan_expired_notification">
                                <option value="1"
                                    {{ $user_plan_expired_notification->is_enabled == 1 ? 'selected' : '' }}>
                                    {{ __('Yes') }}</option>
                                <option value="0"
                                    {{ $user_plan_expired_notification->is_enabled == 0 ? 'selected' : '' }}>
                                    {{ __('No') }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="text" class="form-control" name="user_plan_expired_notification_template_id"
                            value="{{ $user_plan_expired_notification->template_id }}"
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="text" class="form-control" name="user_plan_expired_notification_template_namespace"
                            value="{{ $user_plan_expired_notification->namespace }}"
                            placeholder="{{ __('Template Namespace') }}">
                    </div>

                    {{-- Variables --}}
                    @php
                        $decodedVariabels7 = json_decode($user_plan_expired_notification->variables ?? '[]', true);
                    @endphp
                    <div class="col-12 col-md-6">
                        <h3 class="mb-3"> {{ __('Variables User') }} </h3>
                        <table class="table border" id="variablesTable7">
                            <tr>
                                ...
                                <tr>
                                    <td class="p-3 border-end text-center align-middle">
                                        <input type="checkbox" class="form-check-input variable-check"
                                            {{ isset($decodedVariabels7[$i - 1]) ? 'checked' : '' }}>
                                    </td>
                                    ...
                                    <td class="p-3">
                                        <select class="form-select variable-select variables">
                                            <option value="app_name"
                                                {{ ($decodedVariabels7[$i - 1] ?? '') == 'app_name' ? 'selected' : '' }}>
                                                {{ __('App Name') }}
                                            </option>
                                            <option value="name"
                                                {{ ($decodedVariabels7[$i - 1] ?? '') == 'name' ? 'selected' : '' }}>
                                                {{ __('User Name') }}
                                            </option>
                                            <option value="email"
                                                {{ ($decodedVariabels7[$i - 1] ?? '') == 'email' ? 'selected' : '' }}>
                                                {{ __('User Email') }}
                                            </option>
                                            <option value="plan_name"
                                                {{ ($decodedVariabels7[$i - 1] ?? '') == 'plan_name' ? 'selected' : '' }}>
                                                {{ __('Plan Name') }}
                                            </option>
                                            <option value="expiry_date"
                                                {{ ($decodedVariabels7[$i - 1] ?? '') == 'expiry_date' ? 'selected' : '' }}>
                                                {{ __('Plan Expiry Date') }}
                                            </option>
                                        </select>
                                    </td>
                        ...
                        <input type="hidden" name="variables" id="variablesInput7">
                    </div>
