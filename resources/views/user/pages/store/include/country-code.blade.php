<select name="country_code" id="country_code" class="form-control country_code">
    ...
    <option value="1684" {{ old('country_code') == '1684' ? 'selected' : '' }}>American Samoa (+1684)</option> 
    ...
    <option value="1264" {{ old('country_code') == '1264' ? 'selected' : '' }}>Anguilla (+1264)</option>
    <option value="672" {{ old('country_code') == '672' ? 'selected' : '' }}>Antarctica (+672)</option>
    <option value="1268" {{ old('country_code') == '1268' ? 'selected' : '' }}>Antigua and Barbuda (+1268)</option>
    ...
    <option value="297" {{ old('country_code') == '297' ? 'selected' : '' }}>Aruba (+297)</option>
    ...
    <option value="1242" {{ old('country_code') == '1242' ? 'selected' : '' }}>Bahamas (+1242)</option>
    ...
    <option value="1246" {{ old('country_code') == '1246' ? 'selected' : '' }}>Barbados (+1246)</option>
    ...
    <option value="1441" {{ old('country_code') == '1441' ? 'selected' : '' }}>Bermuda (+1441)</option>
    ...
    <option value="55" {{ old('country_code') == '55' ? 'selected' : '' }}>Brasil (+55)</option>
    <option value="246" {{ old('country_code') == '246' ? 'selected' : '' }}>British Indian Ocean Territory (+246)</option>
    <option value="1284" {{ old('country_code') == '1284' ? 'selected' : '' }}>British Virgin Islands (+1284)</option>
    ...
    <option value="1345" {{ old('country_code') == '1345' ? 'selected' : '' }}>Cayman Islands (+1345)</option>
    ...
    <option value="682" {{ old('country_code') == '682' ? 'selected' : '' }}>Cook Islands (+682)</option>
    ...
    <option value="599" {{ old('country_code') == '599' ? 'selected' : '' }}>Curacao (+599)</option>
    ...
    <option value="243" {{ old('country_code') == '243' ? 'selected' : '' }}>Democratic Republic of the Congo (+243)</option>
    ...
    <option value="1767" {{ old('country_code') == '1767' ? 'selected' : '' }}>Dominica (+1767)</option>
    <option value="1809" {{ old('country_code') == '1809' ? 'selected' : '' }}>Dominican Republic (+1809)</option>
    <option value="1829" {{ old('country_code') == '1829' ? 'selected' : '' }}>Dominican Republic (+1829)</option>
    <option value="1849" {{ old('country_code') == '1849' ? 'selected' : '' }}>Dominican Republic (+1849)</option>
    <option value="670" {{ old('country_code') == '670' ? 'selected' : '' }}>East Timor (+670)</option>
    ...
    <option value="500" {{ old('country_code') == '500' ? 'selected' : '' }}>Falkland Islands (+500)</option>
    <option value="298" {{ old('country_code') == '298' ? 'selected' : '' }}>Faroe Islands (+298)</option>
    ...
    <option value="689" {{ old('country_code') == '689' ? 'selected' : '' }}>French Polynesia (+689)</option>
    ...
    <option value="350" {{ old('country_code') == '350' ? 'selected' : '' }}>Gibraltar (+350)</option>
    <option value="30" {{ old('country_code') == '30' ? 'selected' : '' }}>Greece (+30)</option>
    <option value="299" {{ old('country_code') == '299' ? 'selected' : '' }}>Greenland (+299)</option>
    <option value="1473" {{ old('country_code') == '1473' ? 'selected' : '' }}>Grenada (+1473)</option>
    <option value="1671" {{ old('country_code') == '1671' ? 'selected' : '' }}>Guam (+1671)</option>
    ...
    <option value="225" {{ old('country_code') == '225' ? 'selected' : '' }}>Ivory Coast (+225)</option>
    ...
    <option value="7" {{ old('country_code') == '7' ? 'selected' : '' }}>Kazakhstan (+7)</option>
    <option value="254" {{ old('country_code') == '254' ? 'selected' : '' }}>Kenya (+254)</option>
    <option value="686" {{ old('country_code') == '686' ? 'selected' : '' }}>Kiribati (+686)</option>
    ...
    <option value="389" {{ old('country_code') == '389' ? 'selected' : '' }}>Macedonia (+389)</option>
    ...
    <option value="692" {{ old('country_code') == '692' ? 'selected' : '' }}>Marshall Islands (+692)</option>
    ...
    <option value="262" {{ old('country_code') == '262' ? 'selected' : '' }}>Mayotte (+262)</option>
    <option value="52" {{ old('country_code') == '52' ? 'selected' : '' }}>Mexico (+52)</option>
    <option value="691" {{ old('country_code') == '691' ? 'selected' : '' }}>Micronesia (+691)</option>
    <option value="373" {{ old('country_code') == '373' ? 'selected' : '' }}>Moldova (+373)</option>
    <option value="377" {{ old('country_code') == '377' ? 'selected' : '' }}>Monaco (+377)</option>
    ...
    <option value="1664" {{ old('country_code') == '1664' ? 'selected' : '' }}>Montserrat (+1664)</option>
    ...
    <option value="674" {{ old('country_code') == '674' ? 'selected' : '' }}>Nauru (+674)</option>
    ...
    <option value="599" {{ old('country_code') == '599' ? 'selected' : '' }}>Netherlands Antilles (+599)</option>
    <option value="687" {{ old('country_code') == '687' ? 'selected' : '' }}>New Caledonia (+687)</option>
    ...
    <option value="683" {{ old('country_code') == '683' ? 'selected' : '' }}>Niue (+683)</option>
    <option value="672" {{ old('country_code') == '672' ? 'selected' : '' }}>Norfolk Island (+672)</option>
    <option value="850" {{ old('country_code') == '850' ? 'selected' : '' }}>North Korea (+850)</option>
    <option value="1670" {{ old('country_code') == '1670' ? 'selected' : '' }}>Northern Mariana Islands (+1670)</option>
    ...
    <option value="680" {{ old('country_code') == '680' ? 'selected' : '' }}>Palau (+680)</option>
    <option value="970" {{ old('country_code') == '970' ? 'selected' : '' }}>Palestine (+970)</option>
    ...
    <option value="64" {{ old('country_code') == '64' ? 'selected' : '' }}>Pitcairn (+64)</option>
    ...
    <option value="1787" {{ old('country_code') == '1787' ? 'selected' : '' }}>Puerto Rico (+1787)</option>
    <option value="1939" {{ old('country_code') == '1939' ? 'selected' : '' }}>Puerto Rico (+1939)</option>
    <option value="974" {{ old('country_code') == '974' ? 'selected' : '' }}>Qatar (+974)</option>
    <option value="242" {{ old('country_code') == '242' ? 'selected' : '' }}>Republic of the Congo (+242)</option>
    <option value="262" {{ old('country_code') == '262' ? 'selected' : '' }}>Reunion (+262)</option>
    <option value="40" {{ old('country_code') == '40' ? 'selected' : '' }}>Romania (+40)</option>
    <option value="7" {{ old('country_code') == '7' ? 'selected' : '' }}>Russia (+7)</option>
    <option value="250" {{ old('country_code') == '250' ? 'selected' : '' }}>Rwanda (+250)</option>
    <option value="590" {{ old('country_code') == '590' ? 'selected' : '' }}>Saint Barthelemy (+590)</option>
    <option value="290" {{ old('country_code') == '290' ? 'selected' : '' }}>Saint Helena (+290)</option>
    <option value="1869" {{ old('country_code') == '1869' ? 'selected' : '' }}>Saint Kitts and Nevis (+1869)</option>
    <option value="1758" {{ old('country_code') == '1758' ? 'selected' : '' }}>Saint Lucia (+1758)</option>
    <option value="590" {{ old('country_code') == '590' ? 'selected' : '' }}>Saint Martin (+590)</option>
    <option value="508" {{ old('country_code') == '508' ? 'selected' : '' }}>Saint Pierre and Miquelon (+508)</option>
    <option value="1784" {{ old('country_code') == '1784' ? 'selected' : '' }}>Saint Vincent and the Grenadines (+1784)</option>
    <option value="685" {{ old('country_code') == '685' ? 'selected' : '' }}>Samoa (+685)</option>
    <option value="378" {{ old('country_code') == '378' ? 'selected' : '' }}>San Marino (+378)</option>
    <option value="239" {{ old('country_code') == '239' ? 'selected' : '' }}>Sao Tome and Principe (+239)</option>
    ...
    <option value="248" {{ old('country_code') == '248' ? 'selected' : '' }}>Seychelles (+248)</option>
    ...
    <option value="1721" {{ old('country_code') == '1721' ? 'selected' : '' }}>Sint Maarten (+1721)</option>
    ...
    <option value="677" {{ old('country_code') == '677' ? 'selected' : '' }}>Solomon Islands (+677)</option>
    ...
    <option value="47" {{ old('country_code') == '47' ? 'selected' : '' }}>Svalbard and Jan Mayen (+47)</option>
    <option value="268" {{ old('country_code') == '268' ? 'selected' : '' }}>Swaziland (+268)</option>
    ...
    <option value="670" {{ old('country_code') == '670' ? 'selected' : '' }}>Timor-Leste (+670)</option>
    <option value="228" {{ old('country_code') == '228' ? 'selected' : '' }}>Togo (+228)</option>
    <option value="690" {{ old('country_code') == '690' ? 'selected' : '' }}>Tokelau (+690)</option>
    <option value="676" {{ old('country_code') == '676' ? 'selected' : '' }}>Tonga (+676)</option>
    ...
    <option value="1649" {{ old('country_code') == '1649' ? 'selected' : '' }}>Turks and Caicos Islands (+1649)</option>
    <option value="688" {{ old('country_code') == '688' ? 'selected' : '' }}>Tuvalu (+688)</option>
    ...
    <option value="678" {{ old('country_code') == '678' ? 'selected' : '' }}>Vanuatu (+678)</option>
    <option value="379" {{ old('country_code') == '379' ? 'selected' : '' }}>Vatican (+379)</option>
    ...
    <option value="681" {{ old('country_code') == '681' ? 'selected' : '' }}>Wallis and Futuna (+681)</option>
