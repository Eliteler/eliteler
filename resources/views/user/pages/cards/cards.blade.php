    ...
    <div class="modal modal-blur fade" id="openQR" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-status"></div>
                <div class="modal-body text-center py-4">
                    <h3 class="mb-2">{{ __('Scan QR') }}</h3>
                    <p id="qr_card_name" class="text-muted mb-4" style="font-size:1rem;font-weight:600;"></p>
                    <div id="status_message" class="qr-code mb-3"></div>
