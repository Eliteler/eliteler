...
@php
    $defaultImage = '';
    $type = Request::get('type') ? Request::get('type') : 'business';

    foreach ($themes as $value => $theme) {
        if ($type == 'business') {
            $defaultImage = asset('img/vCards/resort.png');
            $themeId = '588969111153';
