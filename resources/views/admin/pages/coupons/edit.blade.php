        ...
        <div class="container-fluid">
            <div class="row g-2 align-items-center"> 
                <div class="col">
                    ...
                    <h2 class="page-title">
                        <span class="me-1">{{ __($couponDetails->coupon_code) }}</span>
                        {{ __('Details') }}
                    </h2>
                </div>
            </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                <div class="form-label required">{{ __('Coupon Usage') }}</div>
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control text-uppercase" name="code" value="{{ old('code') ?? $couponDetails->coupon_code }}" autocomplete="code" autofocus required>
                                            </div>
                                        </div>
