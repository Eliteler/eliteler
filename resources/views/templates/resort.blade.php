                ...
                <div class="bg-white shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden">
                    ...
                    <div class="relative px-6 -mt-0.5 pb-32 lg:py-6">
                        ...
                        <div class="text-center flex justify-center items-center flex-col z-10">
                            ...
                            {{-- Name --}}
                            <h1 class=" text-3xl font-medium text-[#121212] custom-head">@if(!empty($business_card_details->title2))
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-[#327C91]" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                        ...
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Made with') }}
                                        <a class="text-[#327C91]" href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
                            </div>
