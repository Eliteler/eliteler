                                    ...
                                    @foreach ($feature_details as $feature)
                                        @if ($feature->type == 'iframe')
                                            ...
                                            <div class="overflow-hidden rounded-2xl">
                                                <iframe referrerpolicy="strict-origin-when-cross-origin" width="100%" height="300" src="{{ $feature->content }}"
                                                    title="{{ $feature->label }}" frameborder="0"
                                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                    allowfullscreen></iframe>
                                                {{-- Add Iframe title --}}
                        ...
                        @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                            @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                <div class="relative">
                                    ...
                                    <div class="w-full max-w-full border px-6 pt-9 pb-6 rounded-2xl bg-blue-50 border-blue-100 relative">
                                        <!-- Error Message (hidden by default) -->
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-200 focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50"></textarea>
                                        </div>
                                        {{-- Notes --}}
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <div class="flex flex-row gap-4">
                                                ...
                                                <div class="flex flex-col w-1/2">
                                                    <input type="time" name="service_start_time"
                                                        ...
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-200 focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50 timepicker" />
                                                </div>
                                            </div>
                                        </div>
