                    ...
                    <div class="px-6 -mt-0.5 pb-6 relative">
                        ...
                        <div class="relative z-20 bg-transparent mt-8 flex">
                            ...
                            <div
                                ...
                                {{-- Name --}}
                                <h1 class="text-3xl lg:text-4xl font-extrabold head mb-2">@if(!empty($business_card_details->title2))
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-[#ed2031]" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a><span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
                            </div>
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Made with') }}
                                        <a class="text-[#ed2031]" href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
