                                            ...
                                            <div
                                                ...
                                                <div class="flex flex-col lg:flex-row lg:gap-4 mb-4">
                                                    ...
                                                    <div class="flex flex-col w-full lg:w-1/2">
                                                        <label for="no_of_persons"
                                                            class="text-white font-medium mb-2 block">{{ __('No. of Person(s)') }}</label>
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    <label for="customer_address"
                                                        class="text-white font-medium mb-2 block">{{ __('Address') }}</label>
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    <label for="customer_message"
                                                        class="text-white font-medium mb-2 block">{{ __('Notes') }}</label>
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <label for="service_start_date"
                                                        class="text-white font-medium mb-2 block">{{ __('Service Start DateTime') }}</label>
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <label for="service_end_date"
                                                        class="text-white font-medium mb-2 block">{{ __('Service End DateTime') }}</label>
                                                    <div class="flex flex-row gap-4">
                                                        <div class="flex flex-col w-1/2">
                                ...
                                @if (is_dir(base_path('plugins/GoogleWallet')))
                                    @if (isset($plan_details['google_wallet']) &&
                                        ...
                                        <div class="relative px-6">
                                            ...
                                            <div
                                                class="w-full max-w-full border p-6 rounded-2xl bg-[#282828] text-gray-50 border border-gray-500 relative z-10">
