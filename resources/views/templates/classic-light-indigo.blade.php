                ...
                <div id="profile" class="leading-tight min-h-screen p-1">
                    ...
                    <div
                        ...
                        <div class="border-b px-4 pb-2 {{ $business_card_details->cover_type == 'none' ? 'pt-24' : '' }}">
                            <div class="text-center {{ $business_card_details->cover_type == 'none' ? '-mt-16' : '' }} sm:text-left sm:flex mb-4">
...
<h3 class="font-bold text-gray-800 text-2xl mb-1" style="margin-bottom: 0px; padding-bottom: 0px;">{{ $business_card_details->title2 }}</h3>
@endif
...
@endif
<h3 class="font-bold text-gray-800 text-2xl mb-1">{{ $business_card_details->title }}</h3>
                        ...
                        @if ($service_details != null && !$service_details->isEmpty())
                            <div class="w-full px-5 align-middle py-4 border-b">
                                <p class="text-gray-700 font-semibold text-lg">{{ (App::isLocale('ar') && !empty($service_details[0]->title_ar)) ? $service_details[0]->title_ar : __($service_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($product_details != null && !$product_details->isEmpty())
                            <div class="w-full px-5 align-middle py-4 border-b">
                                <p class="text-dark font-semibold text-lg">{{ (App::isLocale('ar') && !empty($product_details[0]->title_ar)) ? $product_details[0]->title_ar : __($product_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($galleries_details != null && !$galleries_details->isEmpty())
                            <div class="w-full px-5 align-middle py-4 border-b">
                                <p class="text-gray-700 font-semibold text-lg">{{ (App::isLocale('ar') && !empty($galleries_details[0]->title_ar)) ? $galleries_details[0]->title_ar : __($galleries_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($testimonials != null && !$testimonials->isEmpty())
                            <div class="w-full align-middle p-6 border-t border-b">
                                <p class="font-semibold text-lg">{{ (App::isLocale('ar') && !empty($testimonials[0]->title_ar)) ? $testimonials[0]->title_ar : __($testimonials[0]->title) }}</p>
                            </div>
                        ...
                        @if ($iframes != null && !$iframes->isEmpty())
                            @foreach ($iframes as $iframe)
                                ...
                                <div id="youtube" class="px-5 py-4">
                                    <div class="mb-3">
                                        <div class="w-full overflow-hidden rounded-lg shadow-lg">
                                            <iframe referrerpolicy="strict-origin-when-cross-origin" src="{{ $iframe->content }}" class="w-full h-64"
                        ...
                        @if (count($payment_details) > 0)
                            ...
                            <div class="w-full px-5 align-middle py-4 border-b">
                                <p class="font-semibold text-lg">{{ (App::isLocale('ar') && !empty($payment_details[0]->title_ar)) ? $payment_details[0]->title_ar : __($payment_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                ...
                                <div class="w-full px-5 align-middle py-4 border-b">
                                    <p class="text-gray-700 font-semibold text-lg">{{ (App::isLocale('ar') && !empty($business_hours->title_ar)) ? $business_hours->title_ar : __($business_hours->title) }}</p>
                                </div>
                        ...
                        @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                            @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                @include('templates.includes.service-booking', [
                                    ...
                                    'head_style' => 'p-4 text-2xl font-bold capitalize border-b',
                                    'input_style' => 'w-full p-4 text-xs bg-gray-50 outline-none rounded',
                                    'btn_style' => 'mb-2 w-full py-4 bg-gradient-to-br from-indigo-300 to-indigo-800 text-sm rounded-full font-bold text-gray-50 transition duration-200',
                                ])
                            @endif
                        @endif
                        {{-- End Service Booking --}}
                        ...
                        @if (is_dir(base_path('plugins/GoogleWallet')))
                            @if (isset($plan_details['google_wallet']) && $plan_details['google_wallet'] == 1 && $business_card_details->is_google_wallet_hidden == 0)
                                <div class="py-5 lg:py-8 border-b">
                                    <div class="mb-6">
                                        <h3 class="p-4 text-2xl text-dark font-bold capitalize border-b">
                                            {{ __('Google Wallet') }}
                                        </h3>
                                    </div>
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Copyright') }} &copy;
                                        @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-indigo-800" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-indigo-800">{{ $__cr_text }}</span>@endif
