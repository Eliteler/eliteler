...
<body>
    ...
    {{-- ============================================================ MAIN VCARD ============================================================ --}}
    <div class="vcard-container mechanic-theme" id="main-vcard">
...
@endif
                ...
                @if (count($service_details) > 0)
                    <div class="section gsap-fade">
                        <i class="fas fa-cogs decor-icon anim-spin" style="font-size:80px;right:10px;top:10px"></i>
                        <div class="section-header">
                            ...
                            <div class="swiper-wrapper">
                                @foreach ($service_details as $s)
                                    <div class="swiper-slide">
                                        <div class="item-card">
                                            <img src="{{ url($s->service_image) }}" alt="{{ $s->service_name }}" />
                ...
                @if (count($galleries_details) > 0)
                    <div class="section gsap-fade">
                        <i class="fas fa-camera decor-icon anim-rev" style="font-size:60px;right:15px;top:-5px"></i>
                        <div class="section-header">
                                    ...
                                    <div class="swiper-slide">
                                        <div
                                            ...
                                            <img src="{{ url($g->gallery_image) }}" alt="{{ $g->caption }}"
                                                class="gallery-img"
                                                style="height:160px;border-radius:0;border:none" />
                                            @if ($g->caption)
                                                <div
                ...
                @if ($feature_details->where('type', 'youtube')->count() > 0)
                    <div class="section gsap-fade">
                        <i class="fab fa-youtube decor-icon anim-rev" style="font-size:70px;right:10px;top:10px"></i>
                        <div class="section-header">
                                    ...
                                    @if ($feature->type == 'youtube')
                                        <div class="swiper-slide">
                                            <div class="item-card" style="padding:10px">
                                                ...
                                                <h4 style="font-size:18px;margin-top:8px">{{ $feature->label }}</h4>
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
                ...
                @if ($plan_details['business_hours'] == 1 && $business_hours != null && $business_hours->is_display != 0)
                    <div class="section gsap-fade">
                        <i class="far fa-clock decor-icon anim-spin" style="font-size:70px;right:10px;top:20px"></i>
                        <div class="section-header">
                        ...
                        <div class="mech-card" style="border-left-color:var(--text-muted)">
                            ...
                            @else
                                <div style="display:flex;align-items:center;gap:14px;padding:8px 0">
                                    <i class="fas fa-circle-check" style="color:var(--primary);font-size:20px"></i>
                                    <div>
                                        <p
                ...
                @if (count($testimonials) > 0)
                    <div class="section gsap-fade">
                        <i class="fas fa-trophy decor-icon anim-float" style="font-size:70px;left:0;top:-10px"></i>
                        <div class="section-header">
                        ...
                        <div class="wallet-section">
                            ...
                            @if ($google_wallet_details->wallet_link != null)
                                <a href="{{ $google_wallet_details->wallet_link }}" target="_blank"
                                    rel="noopener noreferrer" style="display:block;max-width:240px;margin:0 auto">
                ...
                @if ($socialFeatures->isNotEmpty())
                    <div class="section gsap-fade">
                        <i class="fas fa-users decor-icon anim-rev" style="font-size:60px;right:10px;top:30px"></i>
                        <div class="section-header">
                ...
                @if ($plan_details['contact_form'] == 1 && $business_card_details->enquiry_email != null)
                    <div class="section gsap-fade" id="contact-section">
                        <i class="fas fa-wrench decor-icon anim-float" style="font-size:60px;right:-5px;top:10px"></i>
                        <div class="section-header">
                        ...
                        @endif
                        <form class="mech-card" action="{{ config('app.url') }}/sent-enquiry" method="POST">
                            @csrf
                            ...
                            <button type="submit" class="btn-primary btn-outline">{{ __('Send Message') }}</button>
                        </form>
                    </div>
                @endif
        ...
        <div class="std-modal-box" onclick="event.stopPropagation()">
            ...
            <form id="appointmentForm">
                ...
                <div class="std-modal-footer">
                    <button type="button" class="btn-cancel" onclick="toggleModal()">{{ __('Cancel') }}</button>
    ...
    <div id="scanModal" class="std-modal hidden" onclick="toggleScanModal(false)">
        <div class="std-modal-box" onclick="event.stopPropagation()">
            ...
            <p class="qr-helper"><i
                    class="fas fa-share-alt"></i>{{ __('Share this QR to let others save your contact') }}</p>
        </div>
    </div>
