...
<body id="top" dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
                ...
                @if (!empty($feature_details) && count($feature_details) > 0)
                    ...
                    <div class="bento-box gsap-bento">
                                ...
                                @foreach ($contentFeatures as $feature)
                                    <div class="feature-content-card">
                                        <div class="feature-content-header">
                                            <i class="{{ $feature->icon ?? 'fas fa-info-circle' }} text-primary"></i>
                        ...
                        @if($iconFeatures->isNotEmpty())
                            ...
                            <div class="icon-grid" style="{{ $contentFeatures->isNotEmpty() ? 'margin-top: 20px;' : '' }}">
                                @foreach ($iconFeatures as $feature)
                                    @php
                                        // Generate the href value dynamically
                                        $href = $feature->content ?? 'javascript:void(0);';
                                        if ($feature->type === 'wa') { // Just in case, though 'wa' is in excludedTypes above
                                            $href = 'https://wa.me/' . ltrim($feature->content, '+');
                                        } elseif ($feature->type === 'email') { // Just in case
                    ...
                    @if ($appointment_slots != null)
                        <div class="bento-box highlight-box gsap-bento" id="booking-section">
                            ...
                            <div style="position:relative; z-index:1">
                                ...
                                {{-- Button --}}
                                <button id="add-slot-button" class="btn-primary" onclick="validateAndShowModal()">
                                    {{ __('Book Appointment') }}
                                </button>
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-image-wrapper">
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <span class="product-badge">{{ $product_detail->badge }}</span>
                                                @endif
                        ...
                        <div class="bento-box gsap-bento" id="service-booking-section">
                            ...
                            <div class="w-full max-w-full">
                                ...
                                <form id="serviceBookingForm"
                                    ...
                                    <div class="grid-2">
                                        ...
                                        <div class="flex flex-col mb-4">
                                            ...
                                            <input type="number" name="no_of_persons" id="no_of_persons"
                                                value="1" step="1"
                                                placeholder="{{ __('No. of Person(s)') }}" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    {{-- Notes --}}
                                    <div class="flex flex-col mb-4">
                                        <label for="customer_notes" class="form-label">{{ __('Notes') }}</label>
                                    ...
                                    <div class="flex flex-col mb-4">
                                        ...
                                        <div class="grid-2">
                                            <input type="text" id="service_start_date" name="service_start_date"
                                                ...
                                                placeholder="{{ __('Service Start Date') }}" class="form-control" />
                                    ...
                                    <div class="flex flex-col mb-4">
                                        ...
                                        <div class="grid-2">
                                            <input type="date" id="service_end_date" name="service_end_date"
                                                placeholder="{{ __('Service End Date') }}" class="form-control" />
                ...
                @if ($plan_details['contact_form'] == 1)
                    @if ($business_card_details->enquiry_email != null)
                        <div class="bento-box gsap-bento" id="contact-section">
                            ...
                            @endif
                            @if ($errors->any()) {{-- Add validation error display if you want --}}
    ...
    <div id="appointmentModal" class="modal-overlay hidden">
        ...
        <div class="modal-content bento-box" style="margin: 0;" onclick="event.stopPropagation()">
            ...
            <form id="appointmentForm" style="position: relative; z-index: 1;">
                ...
                <!-- Email Field -->
                <div class="mb-4 text-left">
                    <input type="email" id="email" class="form-control" placeholder="{{ __('Email') }}"
                        required>
                </div>
                ...
                <div class="mb-4 hidden text-left">
                    <input type="text" id="price" class="form-control" placeholder="{{ __('Price') }}"
                        disabled>
                </div>
        ...
        <div class="modal-content bento-box" style="margin:0;" onclick="event.stopPropagation()">
            ...
            <div class="bento-header flex-col justify-center mb-4">
                <i class="fas fa-share-alt anim-float"
                    style="font-size: 40px; color: var(--primary); margin-bottom: 15px;"></i>
                <h2 class="bento-title" style="font-size: 24px; justify-content: center;">{{ __('Share My Card') }}
                </h2>
            </div>
...
@endif
            ...
            <form action="{{ config('app.url') }}/check-password/{{ $business_card_details->card_id }}"
                method="post">
                @csrf
                <input type="password" name="password" id="card-password" placeholder="••••••" maxlength="6" />
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const swiper = new Swiper('.product-swiper', {
                slidesPerView: 1.3, // Adjust this number (1.3, 1.5, 2.2) to get the exact width spacing
                spaceBetween: 15,
                loop: true,
                autoplay: {
                    delay: 2500,
    ...
    <script>
        ...
        const testimonialSwiperInstance = new Swiper(".testimonialSwiper", {
            ...
            autoplay: {
                delay: 4000,
                disableOnInteraction: false
            }, // Using 4000ms delay from previous versions
            observer: true,
            observeParents: true,
            pagination: {
                el: ".testimonialSwiper .swiper-pagination", // SCOPED to this specific Swiper instance
                clickable: true
            },
            breakpoints: {
                320: {
                ...
                768: {
                    slidesPerView: 1
                } // Testimonials usually remain 1 slide on larger mobile/tablet
            }
        });
    </script>
    <script>
