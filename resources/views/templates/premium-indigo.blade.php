            ...
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl">
                    ...
                    <div
                        ...
                        <div class="bottom-style-6">
                            <div class="vcard-h-56 w-full overflow-hidden">
                                <iframe
                                    class="w-full h-full"
                        ...
                        <div class="bottom-style-6">
                            <div class="vcard-h-56 w-full overflow-hidden">
                                <iframe
                                    class="w-full h-full"
                                    referrerpolicy="strict-origin-when-cross-origin"
                                    src="https://www.youtube.com/embed/{{ $business_card_details->cover }}?autoplay=0&mute=1&controls=1&loop=1&playlist={{ $business_card_details->cover }}"
                                    frameborder="0"
                                    allow="autoplay">
                                </iframe>
                            </div>
                        ...
                        <div class="border-b px-4 {{ $business_card_details->cover_type == 'none' ? 'pt-16' : 'xl:pt-4' }} flex flex-row">
...
<p class="text-gray-800">{{ $card_details->sub_title }}</p>
                        ...
                        @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                            @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                @include('templates.includes.service-booking', [
                                    ...
                                    'head_style' => 'bg-indigo-700 w-full mt-4 mb-4 flex justify-center align-middle py-2',
                                    'input_style' => 'w-full p-4 bg-gray-100 font-semibold outline-none rounded',
                                    'btn_style' => 'mb-2 sub-heading w-full py-4 bg-indigo-700 font-bold text-gray-50 transition duration-200',
                                ])
                            @endif
                        @endif
                        {{-- End Service Booking --}}
                        ...
                        @if (is_dir(base_path('plugins/GoogleWallet')))
                            @if (isset($plan_details['google_wallet']) && $plan_details['google_wallet'] == 1 && $business_card_details->is_google_wallet_hidden == 0)
                                <div class="bg-indigo-700 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="heading font-black text-white text-xl px-4 py-2">{{ __('Google Wallet') }}
                                    </p>
                                </div>
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Copyright') }} &copy;
                                        @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-indigo" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-indigo">{{ $__cr_text }}</span>@endif
