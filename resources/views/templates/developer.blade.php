...
<body class="bg-orange-50 min-h-screen"
    ...
    <div id="smooth-wrapper">  
        <div id="smooth-content" class="container max-w-2xl mx-auto lg:my-10 pb-10 lg:pb-0">
...
<h1 class="text-4xl font-medium text-center">{{ $business_card_details->title }}</h1>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                @foreach ($validFeatures as $feature)
                                                    ...
                                                    @endphp
                                                    <!-- {{ $feature->label }} -->
                                                    <a href="{{ $href }}" {{ !empty($href) ? 'target="_blank"' : 'onclick="return false;"' }} class="px-4 pt-8 pb-4 transition-colors rounded-2xl flex flex-col border border-orange-200 bg-orange-50 relative">
                                                        {{-- Background image --}}
                                            ...
                                            @foreach ($feature_details as $feature)
                                                @if ($feature->type == 'youtube')
                                                    ...
                                                    <div class="rounded-2xl overflow-hidden">
                                                        <iframe referrerpolicy="strict-origin-when-cross-origin" width="100%" height="270" src="https://www.youtube.com/embed/{{ $feature->content }}"
                                        ...
                                        <div class="grid grid-cols-1 gap-4 items-center">
                                            ...
                                            @foreach ($feature_details as $feature)
                                                @if ($feature->type == 'iframe')
                                                    <div class="rounded-2xl overflow-hidden">
                                                        {{-- Content --}}
                                                        <iframe referrerpolicy="strict-origin-when-cross-origin" width="100%" height="270" src="{{ $feature->content }}" title="{{ $feature->label }}" frameborder="0"
                                ...
                                @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                                    @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                        <div class="relative">
                                            ...
                                            <div class="w-full max-w-full border px-6 pt-9 pb-6 rounded-2xl bg-orange-50 border-orange-200 relative">
                                                <img src="{{ url('img/templates/developer/icon.png') }}" alt="" class="w-8 absolute top-4 left-4" />
                                                ...
                                                <div class="flex flex-col lg:flex-row lg:gap-4 mb-4">
                                                    ...
                                                    <div class="flex flex-col w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        ...
                                                        <input type="text" name="customer_name" id="customer_name"
                                                            ...
                                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-200 focus:ring-2 focus:ring-orange-600 focus:ring-opacity-50" />
                                                    </div>
                                                    {{-- Email --}}
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-200 focus:ring-2 focus:ring-orange-600 focus:ring-opacity-50"></textarea>
                                                </div>
                                                {{-- Notes --}}
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <div class="flex flex-row gap-4">
                                                        ...
                                                        <div class="flex flex-col w-1/2">
                                                            <input type="time" name="service_start_time"
                                                                ...
                                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-200 focus:ring-2 focus:ring-orange-600 focus:ring-opacity-50 timepicker" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            @foreach ($payment_details as $payment)
                                                ...
                                                <div class="flex flex-col border border-orange-200 bg-orange-50 rounded-2xl px-4 pt-9 pb-4 relative">
                                                    ...
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        {{-- UPI Payment --}}
                                                        @if ($payment->type == 'upi')
                                                            <a href="upi://pay?pa={{ $payment->content }}&pn={{ urlencode($payment->label) }}&am=1&cu=INR" target="_blank" rel="noopener noreferrer">
                                                                <div
                                                                    class="border border-orange-200 bg-orange-100 rounded-full p-2 flex items-center justify-center">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                ...
                                @if (count($feature_details) > 0 && $feature_details->contains('type', 'map'))
                                    <div class="relative">
                                        ...
                                        @foreach ($feature_details as $feature)
                                            @if ($feature->type == 'map')
                                                <iframe referrerpolicy="strict-origin-when-cross-origin" src="https://www.google.com/maps/embed?{!! $feature->content !!}" width="100%" height="300" style="border: 0" allowfullscreen="" loading="lazy"
                                                    class="rounded-t-2xl">
                                                </iframe>
                                                {{-- Map title --}}
                                                @if ($feature->label != null)
                                ...
                                @if ($plan_details['contact_form'] == 1)
                                    @if ($business_card_details->enquiry_email != null)
                                        <div class="relative pb-14 lg:pb-6">
                                            ...
                                            <form class="w-full max-w-full border px-6 pt-9 pb-6 rounded-2xl bg-orange-50 border-orange-200 relative" action="{{ config('app.url') }}/sent-enquiry" method="POST">
                                                @csrf
                                    ...
                                    <div class="pb-1">
                                        <div
                                            ...
                                            <div class="mt-2 text-gray-500">
                                                {{ __('Copyright') }} &copy;
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-orange-500" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-orange-500">{{ $__cr_text }}</span>@endif<span id="year"></span>{{ __('. All Rights Reserved.') }}
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="pb-1">
                                        <div
                                            ...
                                            <div class="mt-2 text-gray-500">
                                                {{ __('Made with') }}
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-orange-500" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-orange-500">{{ $__cr_text }}</span>@endif
                ...
                <div
                    ...
                    <!-- Download Icon -->
                    <div class="flex-1 flex items-center justify-center">
                        <a href="{{ config('app.url') }}/download/{{ $business_card_details->card_id }}" class="border border-orange-200 p-3 rounded-full bg-orange-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
            ...
            <div id="scanModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center qr-modal hidden z-50"
                ...
                <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 border-orange-200 bg-orange-50 qr-modal-overlay"
                    ...
                    <!-- Submit Button -->
                    <div class="flex justify-center">
                        <button onclick="downloadQr('{{ config('app.url') . route('dynamic.card', $business_card_details->card_id, false) }}', 500, '{{ addslashes($business_card_details->title) }}')" id="download"
    ...
    <script>
        function generateOption(selectedDate, day) {
            ...
            fetch("{{ config('app.url') }}/get-available-time-slots", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
