...
<head>
    ...
    @if ($business_card_details != null)
        <style>
            ...
            /* Force iframe height with !important */
            #vid-player {
            ...
            @if ($business_card_details != null)
                <div id="profile" class="leading-tight min-h-screen lg:bg-cover lg:bg-scroll shadow-xl"
                    ...
                    <div
                        ...
                        {{-- Cover Section (All Video & Photo Types) --}}
                        @if ($business_card_details->cover_type == 'photo')
                            <div class="bottom-style-6 relative w-full overflow-hidden">
                        ...
                        @if (in_array($business_card_details->cover_type, ['vimeo-ap', 'vimeo', 'youtube-ap', 'youtube']))
                            <div class="bottom-style-6 relative w-full overflow-hidden">
                                <div class="relative w-full overflow-hidden rounded-t-lg">
                                    @if (Str::startsWith($business_card_details->cover_type, 'vimeo'))
                                        <iframe referrerpolicy="strict-origin-when-cross-origin" id="vid-player"
                                            src="https://player.vimeo.com/video/{{ $business_card_details->cover }}?autoplay={{ $business_card_details->cover_type == 'vimeo-ap' ? 1 : 0 }}&loop=1&muted=1&controls=0"
                                            class="w-full"
                                            frameborder="0"
                                            allow="autoplay; fullscreen; picture-in-picture"
                                            allowfullscreen>
                                        </iframe>
                                    @elseif (Str::startsWith($business_card_details->cover_type, 'youtube'))
                                        <iframe referrerpolicy="strict-origin-when-cross-origin" id="vid-player"
                                            src="https://www.youtube.com/embed/{{ $business_card_details->cover }}?autoplay={{ $business_card_details->cover_type == 'youtube-ap' ? 1 : 0 }}&mute=1&controls=0&loop=1&playlist={{ $business_card_details->cover }}&modestbranding=0&rel=0"
                                            class="w-full"
                                            frameborder="0"
                        ...
                        {{-- Profile + Title Section BELOW the Video --}}
                        <div class="border-b px-4 pt-6 flex flex-row items-center bg-white relative z-10">
                            <div class="text-center sm:text-left sm:flex mb-2 w-1/2">
                                <img class="profile-style-8 h-24 w-24 border-2 border-white mr-4 md:ml-24 lg:ml-12 profile rounded-full object-cover shadow-md"
...
<h3 class="font-bold text-gray-800 text-2xl mb-1 text-center sm:text-left">{{ $business_card_details->title }}</h3>
                        ...
                        @if ($service_details != null && !$service_details->isEmpty())
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ (App::isLocale('ar') && !empty($service_details[0]->title_ar)) ? $service_details[0]->title_ar : __($service_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($product_details != null && !$product_details->isEmpty())
                            ...
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ (App::isLocale('ar') && !empty($product_details[0]->title_ar)) ? $product_details[0]->title_ar : __($product_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($galleries_details != null && !$galleries_details->isEmpty())
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ (App::isLocale('ar') && !empty($galleries_details[0]->title_ar)) ? $galleries_details[0]->title_ar : __($galleries_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($testimonials != null && !$testimonials->isEmpty())
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ (App::isLocale('ar') && !empty($testimonials[0]->title_ar)) ? $testimonials[0]->title_ar : __($testimonials[0]->title) }}</p>
                            </div>
                                    ...
                                    <div id="youtube" class="px-5 py-4 ">
                                        <div class="mb-3">
                                            <div class="w-full overflow-hidden rounded-lg shadow-lg">
                                                <iframe referrerpolicy="strict-origin-when-cross-origin" class="w-full h-64 text-white"
                        ...
                        @if ($iframes != null && !$iframes->isEmpty())
                            @foreach ($iframes as $iframe)
                                ...
                                <div id="youtube" class="px-5 py-4 ">
                                    <div class="mb-3">
                                        <div class="w-full overflow-hidden rounded-lg shadow-lg">
                                            <iframe referrerpolicy="strict-origin-when-cross-origin" class="w-full h-64 text-white" src="{{ $iframe->content }}"
                        ...
                        @if (count($payment_details) > 0)
                            ...
                            <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                <p class="font-black mb-6 text-xl px-4 py-1">{{ (App::isLocale('ar') && !empty($payment_details[0]->title_ar)) ? $payment_details[0]->title_ar : __($payment_details[0]->title) }}</p>
                            </div>
                        ...
                        @if ($plan_details['business_hours'] == 1)
                            @if ($business_hours != null && $business_hours->is_display != 0)
                                ...
                                <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="font-black mb-6 text-xl px-4 py-1">{{ (App::isLocale('ar') && !empty($business_hours->title_ar)) ? $business_hours->title_ar : __($business_hours->title) }}</p>
                                </div>
                        ...
                        @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                            @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                @include('templates.includes.service-booking', [
                                    ...
                                    'head_style' => 'bg-indigo-600 w-full mt-4 mb-4 flex justify-center align-middle py-2',
                                    'input_style' => 'w-full p-4 text-xs bg-gray-100 outline-none rounded',
                                    'btn_style' => 'mb-2 w-full py-4 bg-indigo-600 text-sm rounded-full font-bold text-gray-50 transition duration-200',
                                ])
                            @endif
                        @endif
                        {{-- End Service Booking --}}
                        ...
                        @if (is_dir(base_path('plugins/GoogleWallet')))
                            @if (isset($plan_details['google_wallet']) && $plan_details['google_wallet'] == 1 && $business_card_details->is_google_wallet_hidden == 0)
                                <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="font-black mb-6 text-xl px-4 py-1">{{ __('Google Wallet') }}</p>
                                </div>

                                <div class="py-5 lg:py-8 border-b px-4">
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                ...
                                <div class="ribbon-1 w-full mt-4 mb-4 flex justify-center align-middle py-2">
                                    <p class="font-black mb-6 text-xl px-4 py-1">{{ (App::isLocale('ar') && !empty($business_card_details->contact_form_title_ar)) ? $business_card_details->contact_form_title_ar : __($business_card_details->contact_form_title) }}</p>
                                </div>
                                ...
                                <section class="py-5 lg:py-8 border-b">
                                    <div class="container mx-auto">
                                        <div class="max-w-xl mx-auto">
                                            ...
                                            @endif
                                            <form class="px-4" action="{{ config('app.url') }}/sent-enquiry"
                                                method="POST">
                                                @csrf
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Copyright') }} &copy;
                                        @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-indigo-700" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-indigo-700">{{ $__cr_text }}</span>@endif
