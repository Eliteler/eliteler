...
@endif
                                ...
                                @foreach ($product_details as $product_detail)
                                    <div class="swiper-slide">
                                        <div class="product-card">
                                            ...
                                            <p class="product-description">{{ $product_detail->product_description }}
                                            </p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item-card gallery-card">
                                            ...
                                            @if ($galleries_detail->caption)
                                                <p class="gallery-caption">{{ $galleries_detail->caption }}</p>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @else
                                    <div style="display:flex;align-items:center;gap:16px;padding:8px 0">
                                        <div
                                            ...
                                            <i class="fas fa-clock" style="color:var(--gold);font-size:18px"></i>
                                        </div>
                                        <div>
                                            <p
                            ...
                            <div class="realtor-card service-booking-card">
                                ...
                                <div class="service-booking-form">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="no_of_persons" id="no_of_persons" value="1"
                                            class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="realtor-card"
                                    ...
                                    @if ($payment->type == 'url')
                                        <a href="https://{{ str_replace('https://', '', $payment->content) }}"
                                            target="_blank" class="btn-primary btn-sm">{{ $payment->label }}</a>
                        ...
                        <div class="swiper testimonialSwiper">
                            <div class="swiper-wrapper">
                                @foreach ($testimonials as $testimonial)
                                    <div class="swiper-slide">
                                        <div class="testimonial-card" style="text-align:center;padding:30px 24px">
                    ...
                    @if ($business_card_details->enquiry_email != null)
                        <div class="section gsap-fade" id="contact-section">
                            ...
                            <form class="realtor-card" style="padding:24px"
                                ...
                                <button type="submit" class="btn-primary btn-outline">{{ __('Send') }}</button>
                            </form>
                        </div>
                    @endif
                @endif
    ...
    ============================================================ --}}
                <div class="section branding-footer">
                    ...
                    @else
                        {{ __('Made with') }} <a href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                    @endif
                </div>
        ...
        <div class="pw-modal">
            <div class="pw-modal-box">
                ...
                <form action="{{ config('app.url') }}/check-password/{{ $business_card_details->card_id }}"
                    ...
                    @endif
                    <button type="submit" class="btn-primary" style="margin-top:8px">{{ __('Unlock') }}</button>
                </form>
            </div>
        </div>
    @endif
