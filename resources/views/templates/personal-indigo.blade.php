                    ...
                    <div class="flex flex-wrap template-4 -m-2">
                        <div class="w-full lg:w-1/2">
                            ...
                            <div class="px-4 py-6 lg:bg-white lg:shadow rounded">
                                <div
                                    class="relative {{ $business_card_details->cover_type == 'photo' ? 'pt-40 md:pt-56' : 'pt-10' }} rounded overflow-hidden">

                                    @if ($business_card_details->cover_type == 'photo')
                                        <img class="absolute top-0 left-0 w-full h-52 md:h-64 lg:h-72 object-cover"
                                    ...
                                    <div class="relative flex justify-center -mt-8">
                                        <img class="{{ $business_card_details->cover_type == 'photo' ? 'w-40 h-40' : 'w-48 h-48' }} rounded-full border-4 border-white object-cover object-center shadow-md"
...
<h2 class="font-medium text-xl" style="margin-bottom: 0px; padding-bottom: 0px;">{{ $business_card_details->title2 }}</h2>
@endif
...
<h2 class="font-medium text-xl">{{ $business_card_details->title }}</h2>
                                    ...
                                    <div class="flex flex-wrap justify-center gap-4 px-4 mt-4">
                                        <!-- QR Code -->
                                        <a class="flex qr-modal-open px-5 py-3 items-center justify-center bg-indigo-500 hover:bg-indigo-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                            href="#">
                                        ...
                                        <!-- Send -->
                                        <a class="flex send-modal-open px-5 py-3 items-center justify-center bg-indigo-500 hover:bg-indigo-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                            href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                @if ($feature->type != 'iframe' && $feature->type != 'youtube' && $feature->type != 'map' && $feature->type != 'text')
                                                    <div class="w-1/2 md:w-1/3 px-2 mb-2 md:mb-3">
                                                        ...
                                                        @if ($feature->type == 'email')
                                                            <a class="flex px-5 py-3 items-center justify-center bg-indigo-500 hover:bg-indigo-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                                        ...
                                                        @if ($feature->type == 'tel')
                                                            <a class="flex px-5 py-3 items-center justify-center bg-indigo-500 hover:bg-indigo-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                                                href="tel:{{ $feature->content }}">
                                                        @endif

                                                        {{-- WhatsApp --}}
                                                        @if ($feature->type == 'wa')
                                                            <a class="flex px-5 py-3 items-center justify-center bg-indigo-500 hover:bg-indigo-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                                                href="http://wa.me/{{ $feature->content }}"
                                                        ...
                                                        <span class="ml-3"
                                                            data-config-id="auto-txt-4-1">{{ $feature->label }}</span>
                                ...
                                @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                                    @include('templates.includes.basic-appointment', [
                                        'section_bg' => 'white',
                                        'bg_color' => 'white',
                                        'btn_color' => 'indigo-500',
                                        'text_color' => 'white',
                                    ])
                                @endif
                                ...
                                <div class="lg:py-5 pt-5">
                                    ...
                                    <div class="flex flex-wrap pt-6 -mx-2">
                                        ...
                                        <div class="w-1/5 md:w-1/5 px-2 mb-2 md:mb-0">
                                            <a class="flex justify-center py-2 text-sm text-white bg-indigo-500 hover:bg-indigo-600 rounded-xl transition duration-200"
                                    ...
                                    <div class="lg:pb-0 pb-16">
                                        <div
                                            ...
                                            <div class="mt-2">
                                                ...
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-indigo-500" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-indigo-500">{{ $__cr_text }}</span>@endif
