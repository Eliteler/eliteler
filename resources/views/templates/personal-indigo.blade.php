                                    ...
                                    <div class="lg:pb-0 pb-16">
                                        <div
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <a class="text-indigo-500" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                                    ...
                                    <div class="pb-1">
                                        <div
                                            ...
                                            <div class="mt-2">
                                                ...
                                                {{ __('Made with') }}
                                                <a class="text-indigo-500" href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                                                <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                            </div>
                                        </div>
                                    </div>
