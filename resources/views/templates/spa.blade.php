...
<body class="bg-green-50 min-h-screen"
    ...
    <div id="smooth-wrapper">  
        <div id="smooth-content" class="container max-w-2xl mx-auto lg:my-8 relative">       
...
<h1 class="lg:text-5xl text-3xl font-medium text-[#121212] pDetails" style="margin-bottom: 0px; padding-bottom: 0px;">{{ $business_card_details->title2 }}</h1>
@endif
@if(!empty($business_card_details->subtitle2))
<p class="text-green-500 font-bold mt-2 text-md" style="margin-bottom: 5px; padding-bottom: 0px;">{{ $business_card_details->subtitle2 }}</p>
@endif
<h1 class="lg:text-5xl text-3xl font-medium text-[#121212] pDetails">{{ $business_card_details->title }}</h1>
                                        {{-- Job Title --}}
                                        <p class="text-green-500 font-bold mt-2 text-md">{{ $card_details->sub_title }}</p>
                                        {{-- About --}}
                                            ...
                                            <div class="w-full max-w-full shadow-[0_0_4px_rgba(0,0,0,0.1)] p-8 rounded-2xl">
                                                ...
                                                <div class="flex flex-col lg:flex-row lg:gap-4 mb-4">
                                                    ...
                                                    <div class="flex flex-col w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        ...
                                                        <input type="text" name="customer_name" id="customer_name"
                                                            ...
                                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-80" />
                                                    </div>
                                                    {{-- Email --}}
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-80"></textarea>
                                                </div>
                                                {{-- Notes --}}
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <div class="flex flex-row gap-4">
                                                        ...
                                                        <div class="flex flex-col w-1/2">
                                                            <input type="time" name="service_start_time"
                                                                ...
                                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-80 timepicker" />
                                                        </div>
                                                    </div>
                                                </div>
