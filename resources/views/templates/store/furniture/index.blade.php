...
<body dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #fde8ce6e;">
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card border-0 rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    ...
                    <div class="row p-3 px-lg-4">
                        <div class="row {{ request('category') ? 'ps-2 ps-lg-3' : '' }}">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity-amber rounded-0 col-md-3 my-4 px-3' : 'col-md-12 mb-3' }}">
                                {{-- Filter --}}
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 mt-2 mt-md-0">
                                        <button type="submit"
                                            class="btn btn-teal w-100">{{ __('Filter') }}</button>
                                    </div>
                                </form>

                                <div class="text-center mt-4 mb-3 {{ request('category') ? 'd-none' : '' }}">
                                    <h2
                                        class="head p-2 bg-amber text-white fs-custom fw-medium d-inline-block">
                                        {{ __('Categories') }}
                                    </h2>
                                </div>

                                <div class="mt-4 mb-2 {{ request('category') ? '' : 'd-none' }}">
                                    <h2
                                        class="head p-2 bg-amber text-white fs-custom fw-medium d-inline-block">
                                        {{ __('Categories') }}
                                    </h2>
                                ...
                                <swiper-container space-between="10"
                                    ...
                                    @foreach ($categories as $category)
                                        <swiper-slide class="cursor-pointer">
                                            <a class="card" style="margin: 0.05rem;" href="{{ url($business_card_details->card_url) . '?category=' . urlencode(strtolower($category->category_name)) }}">
                                                <div class="d-flex flex-column align-items-center justify-content-center gap-2 p-3">
                                                    <!-- Thumbnail -->
                                                    <div class="ratio ratio-1x1 d-flex align-items-center justify-content-center overflow-hidden w-100">
                                            ...
                                            <a
                                                ...
                                                <div class="text-decoration-none">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Category Name -->
                                                        <h3
                                                            class="mb-0 fs-3 {{ request('category') == $category_name ? 'text-amber' : 'text-dark' }}">
                                                            {{ __($category->category_name) }}
                                                        </h3>
                                                    </div>
                                                </div>
                            ...
                            <!-- Products -->
                            <div class="mt-2 py-3 {{ request('category') ? 'col-md-9 ps-lg-4 mt-3' : 'col-md-12' }}">                                
                                <div class="row align-items-center {{ request('category') ? 'mt-2' : 'd-none' }}">
                                    ...
                                    <form class="row col-md-8" method="GET" action="{{ url()->current() }}">
                                        ...
                                        <div class="col-3">
                                            <button type="submit"
                                                class="btn btn-teal w-100">{{ __('Search') }}</button>
                                        </div>
                                    </form>
                                ...
                                <!-- Products -->
                                <div class="text-center my-3 {{ request('category') ? 'd-none' : '' }}">
                                    <h2
                                        class="head p-2 bg-amber text-white fs-custom fw-medium d-inline-block">
                                        {{ __('Products') }}
                                    </h2>
                                    ...
                                    <div class="row">
                                            ...
                                            <div
                                                ...
                                                <div class="card pb-3">
                                                    <div class="d-flex flex-column">
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block w-100 rounded-0"
                                                            ...
                                                            <div class="px-3">                                                            
                                                                @if ($product->badge)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span class="badge rounded-0 bg-opacity-amber text-amber">
                                                                            {{ $product->badge }}
                                                                        </span>
                                                                    </div>
                                                                @endif
                                                        ...
                                                        <div class="px-3">
                                                            <!-- Sales Price -->
                                                            <p class="m-0 fs-3 text-teal fw-medium">
                                                    ...
                                                    <div class="mt-2 px-3">
                                                        ...
                                                        @if ($product->product_status == 'instock')
                                                            <a onclick="addToCart('{{ $product->product_id }}')"
                                                                class="btn btn-sm w-100 btn-teal fs-3 p-custom">
                                                                <i
                                        ...
                                        <div class="col-md-12 my-3">
                                            @if (request()->has('category'))
                                                {{ $products->appends(request()->except('page'))->links('vendor.pagination.store', ['color' => 'amber']) }}
                                            @else
                                                {{ $products->links('vendor.pagination.store', ['color' => 'amber']) }}
                                            @endif
                                        </div>
                                    </div>
                                @else
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'teal', 'bg' => 'light'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    @if ($business_card_details != null)
        ...
        @if (
            ...
            <div class="modal fade" id="newsletterModal" tabindex="-1" aria-hidden="true"
                style="background: rgba(0, 0, 0, 0.7);">
                <div class="modal-dialog modal-md modal-dialog-centeamber" role="document">
                    <div class="modal-content">
                        <!-- Modal Header -->
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="{{ config('app.url') }}/subscribe/store/newsletter" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="submit"
                                            class="btn btn-teal w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank"
                                        class="btn btn-teal w-100">{{ __($button_text) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                cart_items +=
                    `<span class="text-dark p-0 d-flex align-items-center justify-content-center fs-3 fw-medium" style="width:35px;height:35px;">${item.qty}</span>`;
                cart_items +=
