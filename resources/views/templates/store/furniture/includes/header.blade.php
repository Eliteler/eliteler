<header class="navbar navbar-expand m-0 p-0 pb-1 bg-amber">
    {{-- Greeting message --}}
    <h3 class="alert alert-important alert-warning bg-teal">
    ...
    <div class="container-xl mx-auto" style="margin-top: -10px;">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                <div class="nav-item">
                    <a class="position-relative cursor-pointer btn-effect mt-1" data-bs-toggle="offcanvas"
                        href="#offcanvasEnd" role="button" aria-controls="offcanvasEnd" onclick="openOffcanvas()">
                        <i class="ti ti-shopping-bag bg-{{ $bg_color }} text-white p-2 rounded-btn"></i>
