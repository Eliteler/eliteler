            ...
            <div class="page-body">
                <div class="container-xl">
                    ...
                    <div class="row pt-6">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-purple p-3">@if(!empty($business_card_details->title2))
...
{{ $business_card_details->sub_title }}
                        ...
                        <div class="row ps-lg-3">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity-purple rounded px-3 col-md-3 my-3' : 'col-md-12 my-3' }}">
                                {{-- Filter --}}
