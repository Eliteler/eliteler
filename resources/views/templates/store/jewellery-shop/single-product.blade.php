                            ...
                            <div class="row text-center text-lg-start align-items-center">
                                <div class="col-lg-6 mb-2 mb-lg-0">
                                    <span class="text-muted">
                                        {{ __('Copyright') }} &copy;
                                        <span id="year"></span>
                                        <a href="{{ url($business_card_details->card_url) }}" class="text-gold fw-semibold">
                                            {{ $card_details->title }}
                                        </a>.
