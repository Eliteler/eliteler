                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <p class="m-0 fs-3 text-white">
                                                                    <span id="{{ $product->product_id }}_currency"><span>{{ formatCurrencyCard($product->sales_price, $currency) }}</span>
                                                                    </span>
                                                                </p>
                        ...
                        <div class="modal-body">
                            <form action="{{ config('app.url') }}/subscribe/store/newsletter" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="submit"
                                            class="btn btn-blue w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank"
                                        class="btn btn-blue w-100">{{ __($button_text) }}</a>
                                </div>
