...
<head>
    ...
    <meta name="theme-color" content="e-commerce-blue" />
    ...
    <!-- Tile for Win8 -->
    <meta name="msapplication-TileColor" content="e-commerce-blue">
    ...
    <style>
        ...
        .card {
           box-shadow: 0 0 6px rgba(0, 0, 0, 0.034) !important;
        }
    ...
    @if ($plan_details != null)
        @if ($plan_details['pwa'] == 1 && $business_card_details->is_enable_pwa == 1 && empty(request()->getQueryString()))
            @laravelPWA
    ...
    <div class="page page-center preloader-wrapper">
        <div class="container container-slim py-4">
            <div class="text-center">
                <div class="spinner-border text-e-commerce-blue" role="status"></div>
            </div>
        </div>
    </div>

    {{-- Page --}}
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #FBFBFB;">
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    <!-- Navbar -->
                    @include('templates.store.e-commerce.includes.header', [
                        'bg_color' => 'e-commerce-blue',
                        'badge_color' => 'red',
                    ])
                    ...
                    <div class="row mt-7 px-3 px-lg-4">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-e-commerce-blue p-3">
                            ...
                            <swiper-container space-between="20" class="mySwiper" autoplay-delay="2500"
                                ...
                                @if (is_array(json_decode($business_card_details->cover)) == true)
                                    @foreach (json_decode($business_card_details->cover) as $cover)
                                        <swiper-slide>
                                            <img class="rounded-e-commerce w-100 h-100 object-fit-cover"
                        ...
                        <div class="row {{ request('category') ? 'ps-2 ps-lg-3' : '' }}">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity card col-md-3 my-3 px-3' : 'col-md-12 my-3' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute"
                                        src="{{ asset('img/templates/e-commerce/7.png') }}"
                                        style="
                                            width: 120px;
                                            height: 120px;
                                            left: -75px;
                                ...
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 mt-2 mt-md-0">
                                        <button type="submit"
                                            class="btn btn-e-commerce-blue w-100">{{ __('Filter') }}</button>
                                    </div>
                                </form>

                                <h2
                                    class="head pt-4 pb-5 text-center position-relative fs-custom fw-bold {{ request('category') ? 'd-none' : '' }}">
                                    {{ __('Categories') }}
                                    <div
                                        class="position-absolute start-50 translate-middle-x bg-e-commerce-blue bottom-bar2">
                                    </div>
                                </h2>
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div class="position-absolute start-0 bg-e-commerce-blue bottom-bar2"></div>
                                </h2>
                                ...
                                <swiper-container space-between="10"
                                    ...
                                    @foreach ($categories as $category)
                                        <swiper-slide class="cursor-pointer">
                                            <a href="{{ url($business_card_details->card_url) . '?category=' . urlencode(strtolower($category->category_name)) }}" class="m-1 card">
                                                <!-- Thumbnail -->
                                                ...
                                                <!-- Category Name -->
                                                <h3 class="fs-3 text-truncate single-product text-dark text-center">
                                        ...
                                        <a href="{{ url()->current() }}" class="text-decoration-none">
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('img/templates/all-categories.png') }}"
                                                    alt="All" class="rounded-e-commerce"
                                            ...
                                            <a
                                                ...
                                                <div class="text-decoration-none">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Category Name -->
                                                        <h3
                                                            class="mb-0 fs-3 {{ request('category') == $category_name ? 'text-e-commerce-blue' : 'text-dark' }}">
                                                            {{ __($category->category_name) }}
                                                        </h3>
                                                    </div>
                                                </div>
                            ...
                            <!-- Products -->
                            <div class="{{ request('category') ? 'col-md-9 ps-lg-4 mt-2' : 'col-md-12' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute" src="{{ asset('img/templates/e-commerce/6.png') }}"
                                        style="
                                            width: 110px;
                                            height: 110px;
                                            top: -16px;
                                ...
                                <div class="position-relative {{ request('category') ? '' : 'd-none' }}">
                                    <img class="position-absolute blur-img"
                                        src="{{ asset('img/templates/e-commerce/6.png') }}" />
                                </div>
                                <div class="row align-items-center {{ request('category') ? 'mt-2' : 'd-none' }}">
                                    <!-- Search Form -->
                                    <form class="row col-md-8" method="GET" action="{{ url()->current() }}">
                                        ...
                                        <div class="col-3">
                                            <button type="submit"
                                                class="btn btn-e-commerce-blue w-100">{{ __('Search') }}</button>
                                        </div>
                                    </form>
                                ...
                                <!-- Products -->
                                <h2
                                    class="head pt-3 pb-5 text-center position-relative fs-custom fw-bold {{ request('category') ? 'd-none' : '' }}">
                                    {{ __('Products') }}
                                    <div
                                        class="position-absolute start-50 translate-middle-x bg-e-commerce-blue bottom-bar2">
                                    </div>
                                ...
                                <h2
                                    class="head pt-5 pb-5 text-start position-relative fs-custom fw-bold {{ request('category') ? '' : 'd-none' }}">
                                    {{ __('Products') }}
                                    <div class="position-absolute start-0 bg-e-commerce-blue bottom-bar2"></div>
                                </h2>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="p-1">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <a
                                                            ...
                                                            <div id="carousel-controls" class="carousel slide mb-3 card"
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block w-100 h-100 rounded-e-commerce"
                                                            ...
                                                            @if ($product->badge)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span class="badge rounded-0 text-e-commerce-blue">
                                                                        {{ $product->badge }}
                                                                    </span>
                                                                </div>
                                                            @endif
                                                            ...
                                                            <h3 id="{{ $product->product_id }}_product_name"
                                                                class="fs-2 single-product mb-1 text-truncate text-dark fw-bold"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div>
                                                                <!-- Sales Price -->
                                                                <p class="m-0 fs-2 text-dark fw-bold">
                                                                ...
                                                                @if ($product->sales_price != $product->regular_price)
                                                                    @if ($product->regular_price)
                                                                        <p class="text-muted fs-3 m-0 fw-bold">
                                                                            <del>{{ formatCurrencyCard($product->regular_price, $currency) }}</del>
                                                                        </p>
                                                                    @endif
                                                                @else
                                                                    <del
                                                                        class="text-white fs-4 m-0">{{ formatCurrencyCard($product->sales_price, $currency) }}</del>
                                                                @endif
                                                            </div>
                                                            ...
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="addToCart('{{ $product->product_id }}')"
                                                                    class="cursor-pointer btn-effect -me-2">
                                                                    <i
                                                                        class="ti ti-shopping-bag-plus bg-e-commerce-blue text-white p-custom fs-1"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                        {{-- Buy Now --}}
                                                        <div class="mt-2">
                                                            <!-- Icon Button -->
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="instantBuy('{{ $product->product_id }}')"
                                                                    class="btn btn-sm w-100 btn-dark btn-effect-loop fs-3 p-custom">
                                                                    <i
                                                                        class="ti ti-bolt text-white fs-2 pe-1"></i>
                                                                        {{ __('Buy Now') }}
                                                                </a>
                                                            @endif
                                                        </div>
                                        ...
                                        <div class="col-md-12 my-3">
                                            @if (request()->has('category'))
                                                {{ $products->appends(request()->except('page'))->links('vendor.pagination.store', ['color' => 'e-commerce-blue']) }}
                                            @else
                                                {{ $products->links('vendor.pagination.store', ['color' => 'e-commerce-blue']) }}
                                            @endif
                                        </div>
                                    </div>
                                @else
                ...
                <!-- Footer -->
                <footer class="footer bg-dark d-print-none mb-7 mb-lg-0 container-xl">
                        ...
                        <div class="row text-center text-lg-start align-items-center">
                            <div class="col-lg-6 mb-2 mb-lg-0">
                                <span class="text-white">
                                    {{ __('Copyright') }} &copy;
                                    <span id="year"></span>
                                    <a href="{{ url($business_card_details->card_url) }}" class="text-e-commerce-blue fw-semibold">
                                        {{ $card_details->title }}
                                    </a>.
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-e-commerce-blue d-flex btn-effect" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer border-top">
            ...
            <!-- Place Order -->
            <a class="btn btn-e-commerce-blue fs-2 btn-effect" id="place-order"
        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Full Name -->
                    <div class="mb-3">
                        <label class="form-label required rounded-0" for="cus_name">{{ __('Full Name') }}</label>
                ...
                <div class="modal-footer">
                    ...
                    <!-- Confirm -->
                    <button type="button" class="btn btn-e-commerce-blue"
    ...
    @if ($business_card_details != null)
        ...
        @if (
            !empty($business_card_details->is_newsletter_pop_active) &&
                ...
                !request()->cookie('newsletter_' . $business_card_details->card_id) &&
                        ...
                        <div class="modal-body">
                            <form action="{{ config('app.url') }}/subscribe/store/newsletter" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="submit"
                                            class="btn btn-e-commerce-blue w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank"
                                        class="btn btn-e-commerce-blue w-100">{{ __($button_text) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                <div class="me-3 flex-shrink-0" style="width: 100px; height: 100px;">
                    <img src="${item.product_image}" class="img-fluid rounded-e-commerce object-fit-cover h-100 w-100" alt="${item.product_name}" />
                </div>`;
            ...
            if (grandTotal > 0) {
                ...
                $("#cart-pricing").html(
                    `<h3 class="font-bold fs-2 d-flex justify-content-between"><span>{{ __('Grand total') }}</span><span class="text-e-commerce-blue">${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</span></h3>`
                );
            } else {
                $("#cart-pricing").html(``);
            }
        ...
        function updateBadge() {
            ...
            if (badgeCount > 0) {
                ...
                $("#place-order").show().attr("class", "btn btn-e-commerce-blue d-flex");
            } else {
                $("#place-order").hide().attr("class", "btn btn-e-commerce-blue d-none");
                $("#badge").hide();
                $("#empty-cart").show();
            }
        }
