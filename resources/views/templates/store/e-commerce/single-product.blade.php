...
<head>
    ...
    <style>
        ...
        .border-blue {
            border:1px solid rgba(133, 166, 255, 0.493) !important;
        }
                        ...
                        <div class="mt-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @endphp
                                    <a href="{{ url($productImages[0]) }}" data-fslightbox="gallery">
                                        <div class="ratio ratio-16x9 mb-2">
                                            <img src="{{ url($productImages[0]) }}" id="product_image"
                                                alt="{{ $product_details->product_name }}"
                                                style="object-fit: cover; object-position: center;"
                                                class="w-100 rounded-e-commerce bg-opacity-gray">
                                        </div>
                                    </a>
                                    <swiper-container space-between="10" class="mySwiper" autoplay-delay="2500"
                                        ...
                                        @foreach ($productImages as $productImage)
                                            <swiper-slide>
                                                <a href="{{ url($productImage) }}" data-fslightbox="gallery">
                                                    <div class="product-image-wrapper">
                                                        <img class="img-fluid w-100 h-100 bg-opacity-gray rounded-e-commerce"
                                                            style="object-fit: cover; object-position: center;"
                                ...
                                <div class="col-md-6 pt-4 p-lg-3">
                                            ...
                                            @if ($product_details->sales_price != $product_details->regular_price)
                                                @if ($product_details->regular_price)
                                                    <p class="text-muted fs-2 m-0">
                                                        <del>{{ formatCurrencyCard($product_details->regular_price, $currency) }}</del>
                                                    </p>
                                                @endif
                                            @endif
                                            <p class="m-0 fs-1 fw-semibold text-dark">
                                                {{ formatCurrencyCard($product_details->sales_price, $currency) }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    @if ($product_details->product_status == 'instock')
                                        <div class="col-12 col-md-6">
                                            <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                class="cursor-pointer btn btn-e-commerce-blue btn-lg w-100 rounded-e-commerce fs-2 fw-bold btn-effect">
                                    ...
                                    {{-- Share --}}
                                    @include('templates.includes.store.share', [
                            ...
                            <div class="row mb-4">
                                <div class="position-relative">
                                    <img class="position-absolute float-loop"
                                        src="{{ asset('img/templates/e-commerce/5.png') }}"
                                        style="
                                            width: 100px;
                                            height: 100px;
                                            right: -35px;
                                ...
                                <h2 class="head py-5 text-center position-relative fs-custom fw-bold">
                                    {{ __('Related Products') }}
                                    <div
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block img-fluid w-100 rounded-e-commerce"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="addToCart('{{ $product->product_id }}')"
                                                                    ...
                                                                    <i
                                                                        class="ti ti-shopping-bag-plus bg-e-commerce-blue text-white p-custom fs-1 rounded-e-commerce"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                        {{-- Buy Now --}}
