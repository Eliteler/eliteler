...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Gloock:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        .card {
            border-radius: 10px;
            box-shadow: 0 0 6px rgba(248, 197, 130, 0.582) !important;
            border:#F4A261 !important;
        }
...
<body dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    {{-- Page --}}
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #FFEDD5;">
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    <!-- Navbar -->
                    @include('templates.store.pet-store.includes.header', [
                        'bg_color' => 'warning',
                        'badge_color' => 'primary',
                    ])
                    ...
                    <div class="row mt-7 px-3 px-lg-4">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-warning p-3">
...
{{ $business_card_details->sub_title }}
                            ...
                            <swiper-container space-between="20" class="mySwiper" autoplay-delay="2500"
                                ...
                                @if (is_array(json_decode($business_card_details->cover)) == true)
                                    @foreach (json_decode($business_card_details->cover) as $cover)
                                        <swiper-slide>
                                            <img class="rounded-pet-store w-100 h-100 object-fit-cover"
                        ...
                        <div class="row {{ request('category') ? 'ps-2 ps-lg-3' : '' }}">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity-warning rounded-pet-store col-md-3 my-3 px-3' : 'col-md-12 my-3' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute rotate-loop"
                                        src="{{ asset('img/templates/pet-store/6.png') }}"
                                        style="
                                            width: 80px;
                                            height: 80px;
                                            left: -20px;
                                ...
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 mt-2 mt-md-0">
                                        <button type="submit"
                                            class="btn btn-warning w-100">{{ __('Filter') }}</button>
                                    </div>
                                </form>
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div
                                        class="position-absolute start-50 translate-middle-x bg-warning bottom-bar2">
                                    </div>
                                </h2>
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div class="position-absolute start-0 bg-warning bottom-bar2"></div>
                                </h2>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex-shrink-0"
                                                            ...
                                                            <img src="{{ url($category->thumbnail) }}"
                                                                class="img-fluid category-thumbnail h-100 w-100 rounded-pet-store"
                                            ...
                                            <a
                                                ...
                                                <div class="text-decoration-none">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Category Name -->
                                                        <h3
                                                            class="mb-0 fs-3 {{ request('category') == $category_name ? 'text-warning' : 'text-dark' }}">
                                                            {{ __($category->category_name) }}
                                                        </h3>
                                                    </div>
                                                </div>
                            ...
                            <div class="mt-2 {{ request('category') ? 'col-md-9 ps-lg-4' : 'col-md-12' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute" src="{{ asset('img/templates/pet-store/2.png') }}"
                                        style="
                                            width: 75px;
                                            height: 75px;
                                            top: 5px;
                                ...
                                <div class="position-relative {{ request('category') ? '' : 'd-none' }}">
                                    <img class="position-absolute blur-img"
                                        src="{{ asset('img/templates/pet-store/7.png') }}" />
                                </div>
                                <div class="row align-items-center {{ request('category') ? 'mt-2' : 'd-none' }}">
                                    ...
                                    <form class="row col-md-8" method="GET" action="{{ url()->current() }}">
                                        ...
                                        <div class="col-3">
                                            <button type="submit"
                                                class="btn btn-warning w-100">{{ __('Search') }}</button>
                                        </div>
                                    </form>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="card d-flex flex-column p-3">
                                                    <div class="d-flex flex-column">
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block w-100 rounded-pet-store"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="">
                                                                <!-- Sales Price -->
                                                                <p class="m-0 fs-3 text-warning fw-bold">
                                                            ...
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="addToCart('{{ $product->product_id }}')"
                                                                    ...
                                                                    <i
                                                                        class="ti ti-shopping-bag-plus bg-warning text-white p-custom fs-1 rounded-btn"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 my-3">
                                            @if (request()->has('category'))
                                                {{ $products->appends(request()->except('page'))->links('vendor.pagination.store', ['color' => 'warning']) }}
                                            @else
                                                {{ $products->links('vendor.pagination.store', ['color' => 'warning']) }}
                                            @endif
                                        </div>
                                    </div>
                                @else
                    ...
                    <div class="footer-wave">
                        <svg viewBox="0 0 1440 100" preserveAspectRatio="none">
                            <path d="M0,0 C360,200 1080,-100 1440,100 L1440,0 L0,0 Z" fill="#E96629" />
                        </svg>
                    </div>
                    <footer class="footer footer-transparent mb-7 mb-lg-0">
                                ...
                                <div class="col-lg-6 mb-2 mb-lg-0">
                                    <span class="text-white">
                                        ...
                                        @if (!isset($plan_details['hide_branding']) || $plan_details['hide_branding'] != 1)
                                            {{ __('Made with') }} <i class="ti ti-heart text-white"></i> {{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}
                                        @endif
                                    </span>
                                </div>
                                    ...
                                    <ul class="list-inline list-inline-dots mb-0">
                                        <li class="list-inline-item">
                                            <a href="{{ $shareComponent['facebook'] }}" target="_blank"
                                                class="link-light">
                                                <i class="ti ti-brand-facebook-filled text-white"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="{{ $shareComponent['twitter'] }}" target="_blank" class="link-light">
                                                <i class="ti ti-brand-twitter-filled text-white"></i>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'warning', 'bg' => 'light'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-warning d-flex btn-effect" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer border-top">
            ...
            <!-- Place Order -->
            <a class="btn btn-warning fs-2 btn-effect" id="place-order"
                        ...
                        <div class="modal-body">
                            <form action="{{ config('app.url') }}/subscribe/store/newsletter" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="submit"
                                            class="btn btn-warning w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank"
                                        class="btn btn-warning w-100">{{ __($button_text) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                <div class="me-3 flex-shrink-0" style="width: 100px; height: 100px;">
                    <img src="${item.product_image}" class="img-fluid rounded-pet-store object-fit-cover h-100 w-100" alt="${item.product_name}" />
                </div>`;
            ...
            if (grandTotal > 0) {
                ...
                $("#cart-pricing").html(
                    `<h3 class="font-bold fs-2 d-flex justify-content-between"><span>{{ __('Grand total') }}</span><span class="text-warning">${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</span></h3>`
                );
            } else {
                $("#cart-pricing").html(``);
            }
        ...
        function updateBadge() {
            ...
            if (badgeCount > 0) {
                ...
                $("#place-order").show().attr("class", "btn btn-warning d-flex");
            } else {
                $("#place-order").hide().attr("class", "btn btn-warning d-none");
                $("#badge").hide();
                $("#empty-cart").show();
            }
        }
