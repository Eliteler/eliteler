        ...
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    ...
                    <!-- Product Details -->
                    <div class="pt-6 px-3 px-lg-4 my-6">
                        <div class="mt-4">
                            <!-- Product Details -->
                            <div class="row">
                                <!-- Product Image -->
                                    ...
                                    <a href="{{ url($productImages[0]) }}" data-fslightbox="gallery">
                                        <div class="ratio ratio-16x9 mb-2">
                                            <img src="{{ url($productImages[0]) }}" id="product_image"
                                                ...
                                                class="w-100 rounded-pet-store bg-opacity-gray">
                                        </div>
                                    </a>
                                            ...
                                            <swiper-slide>
                                                <a href="{{ url($productImage) }}" data-fslightbox="gallery">
                                                    <div class="product-image-wrapper">
                                                        <img class="img-fluid w-100 h-100 bg-opacity-gray rounded-pet-store"
                                                            style="object-fit: cover; object-position: center;"
                                    ...
                                    <div class="d-flex gap-2 align-items-end">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            @if ($product_details->sales_price != $product_details->regular_price)
                                                ...
                                                @endif
                                            @endif
                                            <p class="m-0 fs-1 fw-semibold text-warning">
                                    ...
                                    @if ($product_details->product_status == 'instock')
                                        <div class="col-12 col-md-6">
                                            <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                class="cursor-pointer btn btn-warning btn-lg w-100 rounded-pet-store fs-2 fw-bold btn-effect">
                            ...
                            <div class="row">
                                <div class="position-relative">
                                    <img class="position-absolute floater-img"
                                        src="{{ asset('img/templates/pet-store/1.png') }}"
                                        style="
                                            width: 90px;
                                            height: 90px;
                                            left: -20px;
                                ...
                                <div class="col-md-12">
                                    <swiper-container space-between="10" class="mySwiper" autoplay-delay="2500"
                                        ...
                                        @foreach ($related_products as $product)
                                            <swiper-slide>
                                                <div class="card border-warning d-flex flex-column p-3 m-1">
                                                    <div class="d-flex flex-column">
                                                        @php
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block img-fluid w-100 rounded-pet-store"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="addToCart('{{ $product->product_id }}')"
                                                                    ...
                                                                    <i
                                                                        class="ti ti-shopping-bag-plus bg-warning text-white p-custom fs-1 rounded-pet-store"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                    </div>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                cart_items += `<div class="card border-warning p-3">`;
