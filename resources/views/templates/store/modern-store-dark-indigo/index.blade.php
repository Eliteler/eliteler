                                        ...
                                        <form class="row col-md-8" method="GET" action="{{ url()->current() }}">
                                            ...
                                            <div class="col-9">
                                                <input type="text" name="query"
                                                    placeholder="{{ __('Search') }}" value="{{ request('query') }}"
                                                    class="form-control" />
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="text" class="form-control" id="newsletter_email"
                                                placeholder="{{ __('Your email address') }}" name="email"
                                                required />
                                        </div>
                                        <!-- Button -->
                                        <div class="col-4">
                                            <button type="submit"
                                                class="btn btn-indigo w-100">{{ __('Subscribe') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="row d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        <a href="{{ $button_url }}" target="_blank"
                                            class="btn btn-indigo w-100">{{ __($button_text) }}</a>
                                    </div>
