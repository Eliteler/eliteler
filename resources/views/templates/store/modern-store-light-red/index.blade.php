                ...
                <div class="container-xl">
                    ...
                    <div class="row pt-6">
                        ...
                        <div class="row ps-lg-3">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity-red rounded px-3 col-md-3 my-3' : 'col-md-12 my-3' }}">
                                {{-- Filter --}}
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 col-6">
                                        <input type="number" name="min" class="form-control" placeholder="{{ __('Min') }}"
                                            step="0.01" min="0" value="{{ request('min') }}">
                                    </div>

                                    <!-- Max Price -->
                                    <div class="col-md-4 col-6">
                                        <input type="number" name="max" class="form-control" placeholder="{{ __('Max') }}"
