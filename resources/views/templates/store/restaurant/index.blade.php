...
<head>
    ...
    <meta name="theme-color" content="restaurant-red" />
    ...
    <!-- Tile for Win8 -->
    <meta name="msapplication-TileColor" content="restaurant-red">
    ...
    <style>
        ...
        .card {
            box-shadow: 0 0 6px rgba(252, 142, 142, 0.493) !important;
            border:rgba(252, 94, 94, 0.452) !important;
        }
    ...
    <div class="page page-center preloader-wrapper">
        <div class="container container-slim py-4">
            <div class="text-center">
                <div class="spinner-border text-restaurant-red" role="status"></div>
            </div>
        </div>
    </div>

    {{-- Page --}}
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #F9C5C5;">
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    <!-- Navbar -->
                    @include('templates.store.restaurant.includes.header', [
                        'bg_color' => 'restaurant-red',
                        'badge_color' => 'primary',
                    ])
                    ...
                    <div class="row mt-7 px-3 px-lg-4">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-restaurant-red p-3">
                            ...
                            <swiper-container space-between="20" class="mySwiper" autoplay-delay="2500"
                                ...
                                @if (is_array(json_decode($business_card_details->cover)) == true)
                                    @foreach (json_decode($business_card_details->cover) as $cover)
                                        <swiper-slide>
                                            <img class="rounded-restaurant w-100 h-100 object-fit-cover"
                        ...
                        <div class="row {{ request('category') ? 'ps-2 ps-lg-3' : '' }}">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity-red card col-md-3 my-3 px-3' : 'col-md-12 my-3' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute rotate-loop"
                                        src="{{ asset('img/templates/restaurant/2.png') }}"
                                        style="
                                            width: 130px;
                                            height: 130px;
                                            left: -75px;
                                ...
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 mt-2 mt-md-0">
                                        <button type="submit"
                                            class="btn btn-restaurant-red w-100">{{ __('Filter') }}</button>
                                    </div>
                                </form>
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div
                                        class="position-absolute start-50 translate-middle-x bg-restaurant-red bottom-bar3">
                                    </div>
                                </h2>
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div class="position-absolute start-0 bg-restaurant-red bottom-bar3"></div>
                                </h2>
                                ...
                                <swiper-container space-between="10"
                                    ...
                                    @foreach ($categories as $category)
                                        <swiper-slide class="cursor-pointer">
                                            <a href="{{ url($business_card_details->card_url) . '?category=' . urlencode(strtolower($category->category_name)) }}">
                                                <div class="mt-2">
                                                    <!-- Thumbnail -->
                                                    <div class="image-wrapper mx-auto mb-2 card p-2 rounded-restaurant">
                                                        <img src="{{ url($category->thumbnail) }}"
                                                            class="img-fluid category-thumbnail rounded-restaurant"
                                        ...
                                        <a href="{{ url()->current() }}" class="text-decoration-none">
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('img/templates/all-categories.png') }}"
                                                    alt="All" class="rounded-restaurant"
                                            ...
                                            <a
                                                ...
                                                <div class="text-decoration-none">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Category Name -->
                                                        <h3
                                                            class="mb-0 fs-3 {{ request('category') == $category_name ? 'text-restaurant-red' : 'text-dark' }}">
                                                            {{ __($category->category_name) }}
                                                        </h3>
                                                    </div>
                                                </div>
                            ...
                            <div class="{{ request('category') ? 'col-md-9 ps-lg-4 mt-2' : 'col-md-12' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute float-loop" src="{{ asset('img/templates/restaurant/3.png') }}"
                                        style="
                                            width: 115px;
                                            height: 115px;
                                            top: -20px;
                                ...
                                <div class="position-relative {{ request('category') ? '' : 'd-none' }}">
                                    <img class="position-absolute blur-img float-loop"
                                        src="{{ asset('img/templates/restaurant/3.png') }}" />
                                </div>
                                <div class="row align-items-center {{ request('category') ? 'mt-2' : 'd-none' }}">
                                    ...
                                    <form class="row col-md-8" method="GET" action="{{ url()->current() }}">
                                        ...
                                        <div class="col-3">
                                            <button type="submit"
                                                class="btn btn-restaurant-red w-100">{{ __('Search') }}</button>
                                        </div>
                                    </form>
                                    ...
                                    <div class="row">
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block w-100 h-100 rounded-restaurant"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="addToCart('{{ $product->product_id }}')"
                                                                    ...
                                                                    <i
                                                                        class="ti ti-shopping-bag-plus bg-restaurant-red text-white p-custom fs-1 rounded-restaurant"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 my-3">
                                            @if (request()->has('category'))
                                                {{ $products->appends(request()->except('page'))->links('vendor.pagination.store', ['color' => 'restaurant-red']) }}
                                            @else
                                                {{ $products->links('vendor.pagination.store', ['color' => 'restaurant-red']) }}
                                            @endif
                                        </div>
                                    </div>
                                @else
                                ...
                                <div class="row text-center text-lg-start align-items-center">
                                    <div class="col-lg-6 mb-2 mb-lg-0">
                                        <span class="text-muted">
                                            {{ __('Copyright') }} &copy;
                                            <span id="year"></span>
                                            <a href="{{ url($business_card_details->card_url) }}" class="text-restaurant-red fw-semibold">
                                                {{ $card_details->title }}
                                            </a>.
                                        ...
                                        <ul class="list-inline list-inline-dots mb-0">
                                            <li class="list-inline-item">
                                                <a href="{{ $shareComponent['facebook'] }}" target="_blank"
                                                    class="link-light">
                                                    <i class="ti ti-brand-facebook-filled text-restaurant-red"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="{{ $shareComponent['twitter'] }}" target="_blank" class="link-light">
                                                    <i class="ti ti-brand-twitter-filled text-restaurant-red"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="{{ $shareComponent['linkedin'] }}" target="_blank"
                                                    class="link-light">
                                                    <i class="ti ti-brand-linkedin text-restaurant-red"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="{{ $shareComponent['telegram'] }}" target="_blank"
                                                    class="link-light">
                                                    <i class="ti ti-brand-telegram text-restaurant-red"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="{{ $shareComponent['whatsapp'] }}" target="_blank"
                                                    class="link-light">
                                                    <i class="ti ti-brand-whatsapp text-restaurant-red"></i>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'restaurant-red', 'bg' => 'light'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-restaurant-red d-flex btn-effect" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer border-top">
            ...
            <!-- Place Order -->
            <a class="btn btn-restaurant-red fs-2 btn-effect" id="place-order"
        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <!-- Confirm -->
                    <button type="button" class="btn btn-restaurant-red"
                        ...
                        <div class="modal-body">
                            <form action="{{ config('app.url') }}/subscribe/store/newsletter" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="submit"
                                            class="btn btn-restaurant-red w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank"
                                        class="btn btn-restaurant-red w-100">{{ __($button_text) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                <div class="me-3 flex-shrink-0" style="width: 100px; height: 100px;">
                    <img src="${item.product_image}" class="img-fluid rounded-restaurant object-fit-cover h-100 w-100" alt="${item.product_name}" />
                </div>`;
            ...
            if (grandTotal > 0) {
                ...
                $("#cart-pricing").html(
                    `<h3 class="font-bold fs-2 d-flex justify-content-between"><span>{{ __('Grand total') }}</span><span class="text-restaurant-red">${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</span></h3>`
                );
            } else {
                $("#cart-pricing").html(``);
            }
        ...
        function updateBadge() {
            ...
            if (badgeCount > 0) {
                ...
                $("#place-order").show().attr("class", "btn btn-restaurant-red d-flex");
            } else {
                $("#place-order").hide().attr("class", "btn btn-restaurant-red d-none");
                $("#badge").hide();
                $("#empty-cart").show();
            }
        }
