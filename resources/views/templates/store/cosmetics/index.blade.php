            ...
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    ...
                    <div class="row mt-7 px-3 px-lg-4">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-rose p-3">@if(!empty($business_card_details->title2))
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="ratio ratio-1x1 d-flex align-items-center justify-content-center">
                                                            <img 
                                                                ...
                                                                class="rounded-cosmetics img-fluid category-thumbnail"
                                                            >
                                                        </div>
                                                        <!-- Category Name -->                                                        
                                            ...
                                            <div
                                                ...
                                                <div class="card d-flex flex-column p-3">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        @endphp
                                                        <a
                                                            href="{{ route('profile.single-product', ['id' => $business_card_details->card_url, 'product_id' => $product->id]) }}">
