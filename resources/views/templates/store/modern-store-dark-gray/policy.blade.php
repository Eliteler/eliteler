...
<body data-bs-theme="dark" dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    <div id="wrapper" class="page">
        <!-- Navbar -->
        @include('templates.includes.header', ['bg_color' => 'gray', 'badge_color' => 'danger'])
                ...
                <div class="container-xl">
                    <div class="card card-lg">
                        <div class="card-header">
                            <h1 class="card-title policy-title">{{ __($pageTitle) }}</h1>
                        </div>
                        <div class="card-body">
...
@endif
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'gray', 'bg' => 'dark'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-gray d-flex btn-effect" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer">
            ...
            <!-- Place Order -->
            <a class="btn btn-gray fs-2 btn-effect" id="place-order"
    ...
    <script>
        ...
        function updateList() {
            ...
            if (grandTotal > 0) {
                ...
                $("#cart-pricing").html(
                    `<h3 class="font-bold fs-2 d-flex justify-content-between"><span>{{ __('Grand total') }}</span><span class="text-gray">${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</span></h3>`
                );
            } else {
                $("#cart-pricing").html(``);
            }
        ...
        function updateBadge() {
            ...
            if (badgeCount > 0) {
                ...
                $("#place-order").show().attr("class", "btn btn-gray d-flex");
            } else {
                $("#place-order").hide().attr("class", "btn btn-gray d-none");
                $("#badge").hide();
                $("#empty-cart").show();
            }
        }
