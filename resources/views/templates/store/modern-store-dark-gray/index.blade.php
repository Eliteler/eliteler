            ...
            <div class="page-body">
                <div class="container-xl">
                    ...
                    <div class="row pt-6">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-secondary p-3">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="">
                                                                ...
                                                                @else
                                                                    <del
                                                                        class="text-dark fs-3 m-0">{{ formatCurrencyCard($product->sales_price, $currency) }}</del>
                                                                @endif
                                                            </div>
                        ...
                        <div class="modal-body">
                            <form action="{{ config('app.url') }}/subscribe/store/newsletter" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="submit"
                                            class="btn btn-secondary w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank"
                                        class="btn btn-secondary w-100">{{ __($button_text) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
