...
<head>
   ...
   @php
    ...
    <link href="{{ url('templates/css/store/toy-store.css') }}" rel="stylesheet">
    {{-- Swiper CSS --}}
    <link rel="stylesheet" href="{{ url('css/swiper-bundle.min.css') }}">
    
    <!-- Baloo and Poppins -->
    <link href="https://fonts.googleapis.com/css2?family=Baloo+2:wght@400;500;700&family=Poppins:wght@400;500;600&display=swap" rel="stylesheet">
...
<body dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    {{-- Page --}}
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #F876761A;">
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    <!-- Navbar -->                    
                    @include('templates.store.toy-store.includes.header', [
                        'bg_color' => 'yellow',
                        'badge_color' => 'primary',
                    ])
                    ...
                    <!-- Banner Images -->
                    <div class="w-100 position-relative" style="margin-top: -3px;">
                        <!-- Swiper Slider -->
                        ...
                        <!-- Mobile Version: Fewer big puffs -->
                        <svg viewBox="0 0 1440 150" preserveAspectRatio="none"
                            class="position-absolute bottom-0 start-0 w-100 d-block d-md-none"
                            style="height:70px; z-index:5; overflow:hidden;">
                            <path fill="#FFFFFF" d="
                                M0,120 
                                Q 240,60 480,120
                                Q 720,60 960,120
                        ...
                        <!-- Desktop Version: Many smaller puffs -->
                        <svg viewBox="0 0 1440 150" preserveAspectRatio="none"
                            class="position-absolute bottom-0 start-0 w-100 d-none d-md-block"
                            style="height:150px; z-index:5; overflow:hidden;">
                            <path fill="#FFFFFF" d="
                                M0,120 
                                Q 80,60 160,120
                                Q 240,60 320,120
                    ...
                    <div class="row px-3 px-lg-4">
                        <div class="row {{ request('category') ? 'ps-2 ps-lg-3' : '' }}">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity-red rounded-toy-store col-md-3 mb-3 px-3' : 'col-md-12 mb-3' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute rotate-loop"
                                        src="{{ asset('img/templates/toy-store/7.png') }}"
                                        style="
                                            width: 110px;
                                            height: 110px;
                                            left: -40px;
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div
                                        class="position-absolute start-50 translate-middle-x bg-red bottom-bar2">
                                    </div>
                                </h2>
                                    ...
                                    @foreach ($categories as $category)
                                        <swiper-slide class="cursor-pointer">
                                            <a href="{{ url($business_card_details->card_url) . '?category=' . urlencode(strtolower($category->category_name)) }}">
                                                <div class="mt-2">
                                                    <!-- Thumbnail -->
                                                    <div class="image-wrapper mx-auto mb-2 p-2 card rounded-circle">
                            ...
                            <div class="mt-2 {{ request('category') ? 'col-md-9 ps-lg-4' : 'col-md-12' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute" src="{{ asset('img/templates/toy-store/2.png') }}"
                                        style="
                                            width: 90px;
                                            height: 90px;
                                            top: -15px;
                                ...
                                <div class="position-relative {{ request('category') ? '' : 'd-none' }}">
                                    <img class="position-absolute blur-img"
                                        src="{{ asset('img/templates/toy-store/4.png') }}" />
                                </div>
                                                        ...
                                                        <a
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block w-100 rounded-toy-store"
                                                            ...
                                                            @if ($product->badge)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span class="badge rounded-toy-store bg-opacity-red">
                                                                        {{ $product->badge }}
                                                                    </span>
                                                                </div>
                                                            @endif
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        @if ($product->product_status == 'instock')
                                                            <a onclick="addToCart('{{ $product->product_id }}')"
                                                                class="btn btn-sm w-100 btn-red btn-effect-loop fs-3 p-custom">
                                                                <i
                    ...
                    <div class="footer-wave">
                        <svg viewBox="0 0 1440 100" preserveAspectRatio="none">
                            <path d="M0,0 C360,200 1080,-100 1440,100 L1440,0 L0,0 Z" fill="#FF3B3F" />
                        </svg>
                    </div>
                        ...
                        <div class="modal-body">
                            <form action="{{ config('app.url') }}/subscribe/store/newsletter" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button type="submit"
                                            class="btn btn-red w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank"
                                        class="btn btn-red w-100">{{ __($button_text) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                <div class="me-3 flex-shrink-0" style="width: 100px; height: 100px;">
                    <img src="${item.product_image}" class="img-fluid rounded-toy-store object-fit-cover h-100 w-100" alt="${item.product_name}" />
                </div>`;
    ...
    {{-- Newsletter Popup --}}
    @if (!request()->cookie('newsletter_' . $business_card_details->card_id))
        <script>
            "use strict";
