                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="ratio ratio-16x9 mb-2">
                                        <img src="{{ url($productImages[0]) }}" id="product_image"
                                            ...
                                            class="w-100 rounded-toy-store bg-opacity-gray">
                                    </div>
                                        ...
                                        @foreach ($productImages as $productImage)
                                            <swiper-slide>
                                                <div class="product-image-wrapper">
                                                    <img class="img-fluid w-100 h-100 bg-opacity-gray rounded-toy-store"
                                                        style="object-fit: cover; object-position: center;"
                                    ...
                                    <div class="d-flex gap-2 align-items-end">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            @if ($product_details->sales_price != $product_details->regular_price)
                                                ...
                                                @endif
                                            @endif
                                            <p class="m-0 fs-1 fw-semibold text-red">
                                    ...
                                    @if ($product_details->product_status == 'instock')
                                        <div class="col-12 col-md-6">
                                            <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                class="cursor-pointer btn btn-red btn-lg w-100 rounded-toy-store fs-2 fw-bold btn-effect">
                                ...
                                <div class="col-md-12">
                                    <swiper-container space-between="10" class="mySwiper" autoplay-delay="2500"
                                        ...
                                        @foreach ($related_products as $product)
                                            <swiper-slide>
                                                <div class="card d-flex flex-column p-3 m-1">
                                                    <div class="d-flex flex-column">
                                                        @php
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                cart_items += `<div class="card border-red p-3">`;
