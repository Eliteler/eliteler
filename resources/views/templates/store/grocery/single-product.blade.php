                                    ...
                                    <a href="{{ url($productImages[0]) }}" data-fslightbox="gallery">
                                        <div class="ratio ratio-16x9 mb-2">
                                            <img src="{{ url($productImages[0]) }}" id="product_image"
                                                ...
                                                class="w-100 rounded-grocery bg-opacity-gray">
                                        </div>
                                    </a>
                                            ...
                                            <swiper-slide>
                                                <a href="{{ url($productImage) }}" data-fslightbox="gallery">
                                                    <div class="product-image-wrapper">
                                                        <img class="img-fluid w-100 h-100 bg-opacity-gray rounded-grocery"
                                                            style="object-fit: cover; object-position: center;"
                                    ...
                                    @if ($product_details->product_status == 'instock')
                                        <div class="col-12 col-md-6">
                                            <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                class="cursor-pointer btn btn-grocery-green btn-lg w-100 rounded-grocery fs-2 fw-bold btn-effect">
                            ...
                            <div class="row">
                                <div class="position-relative">
                                    <img class="position-absolute floater-img"
                                        src="{{ asset('img/templates/grocery/6.png') }}"
                                        style="
                                            width: 90px;
                                            height: 90px;
                                            left: -25px;
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block img-fluid w-100 rounded-grocery"
