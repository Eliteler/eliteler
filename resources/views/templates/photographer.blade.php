    ...
    <div id="smooth-wrapper">  
        <div id="smooth-content" class="container max-w-2xl mx-auto">
            ...
            @if ($business_card_details->password == null || Session::get('password_protected') == true)
                {{-- Check business details --}}
                @if ($business_card_details != null)
                    <div class="bg-gradient-to-tl from-[#ffa48c] to-[#ffd1a8] shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden lg:my-10 lg:rounded-2xl relative">
                        {{-- Index Screen --}}
                        @if ($introScreen != null)
                        ...
                        <div id="content-screen">
                            ...
                            <div class="-mt-0.5 pb-32 lg:pb-6 px-6">
                                ...
                                <div class="text-center mt-10 relative flex">
                                    ...
                                    <div
                                        class="relative z-10 flex flex-col w-9/12 lg:ltr:ml-10 lg:rtl:mr-10 ltr:ml-6 rtl:mr-6">
                                        {{-- Name --}}
...
<p class="text-orange-600 text-lg font-bold mt-1 text-md text-start" style="margin-bottom: 5px; padding-bottom: 0px;">{{ $business_card_details->subtitle2 }}</p>
@endif
<h1 class="lg:text-5xl text-3xl font-medium text-gray-900 head text-start">{{ $business_card_details->title }}</h1>
                                        {{-- Job Title --}}
                                        <p class="text-orange-600 text-lg font-bold mt-1 text-md text-start">{{ $card_details->sub_title }}</p>
                                        {{-- About --}}
                                    ...
                                    @if ($hasAddressType)
                                        <div class="relative">
                                            <img src="{{ asset('img/templates/photographer/8.png') }}" alt=""
                                                class="w-28 absolute -top-[92px] lg:-top-[92px] -left-4 opacity-80 lg:hidden" />
                                            @foreach ($feature_details as $feature)
