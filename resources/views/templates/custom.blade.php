                        ...
                        @if ($custom_styles['layout'] == 'row')
                            <div class="text-start mt-4 relative flex z-20">
                                ...
                                <div class="relative flex flex-col ml-6">
                                    {{-- Name --}}
                                    <h1
                                        class="lg:text-4xl text-2xl font-medium text-[{{ $custom_styles['title_color'] }}] tracking-tighter">@if(!empty($business_card_details->title2))
                        ...
                        @if (is_dir(base_path('plugins/GoogleWallet')))
                            @if (isset($plan_details['google_wallet']) && $plan_details['google_wallet'] == 1 && $business_card_details->is_google_wallet_hidden == 0)
                                <div class="relative">
                                    ...
                                    <div class="w-full max-w-full border px-6 pt-9 pb-6 bg-white @if ($custom_styles['card_edge'] == 'rounded') rounded-2xl @endif relative z-10">
                                        {{-- Pass/Ticket Description --}}
                                        @if ($google_wallet_details->wallet_description != null)
                                            <div class="text-sm text-[{{ $custom_styles['description_color'] }}]">
                                    ...
                                    <form
                                        ...
                                        <div class="grid grid-cols-1 gap-2 ">
                                            ...
                                            <div>
                                                ...
                                                <input type="email" name="email" placeholder="{{ __('Your Email') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none" required />
                                            </div>
                                            {{-- Mobile Number --}}
                                            <div>
                                                <label for="phone"
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-[{{ $custom_styles['sub_title_color'] }}]">
                                        {{ __('Made with') }}
                                        <a class="text-[{{ $custom_styles['title_color'] }}]"
                                            href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
