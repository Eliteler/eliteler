...
<h2 class="font-medium text-xl">{{ $business_card_details->title }}</h2>
                                    ...
                                    <div class="flex flex-wrap justify-center gap-4 px-4 mt-4">
                                        <!-- QR Code -->
                                        <a class="flex qr-modal-open px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                            href="#">
                                        ...
                                        <!-- Send -->
                                        <a class="flex send-modal-open px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                            href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                @if ($feature->type != 'iframe' && $feature->type != 'youtube' && $feature->type != 'map' && $feature->type != 'text')
                                                    <div class="w-1/2 md:w-1/3 px-2 mb-2 md:mb-3">
                                                        ...
                                                        @if ($feature->type == 'email')
                                                            <a class="flex px-5 py-3 items-center justify-center bg-blue-500 hover:bg-blue-600 text-sm leading-6 font-bold text-white rounded-xl transition duration-200"
                                ...
                                <div class="lg:py-5 pt-5">
                                    ...
                                    <div class="flex flex-wrap pt-6 -mx-2">
                                        ...
                                        <div class="w-1/5 md:w-1/5 px-2 mb-2 md:mb-0">
                                            <a class="flex justify-center py-2 text-sm text-white bg-blue-500 hover:bg-blue-600 rounded-xl transition duration-200"
                                    ...
                                    <div class="lg:pb-0 pb-16">
                                        <div
                                            ...
                                            <div class="mt-2">
                                                ...
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-blue-500" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-blue-500">{{ $__cr_text }}</span>@endif
