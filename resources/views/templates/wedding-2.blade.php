...
<p class="text-black font-medium text-md text-pink-700" style="margin-bottom: 5px; padding-bottom: 0px;">{{ $business_card_details->subtitle2 }}</p>
@endif
<h1 class="text-4xl lg:text-6xl font-extrabold head">{{ $business_card_details->title }}</h1>
                                        {{-- Job Title --}}
                                        <p class="text-black font-medium text-md text-pink-700">{{ $card_details->sub_title }}</p>
                                        {{-- About --}}
                                ...
                                @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                                    @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                        <div class="relative">
                                            ...
                                            <div class="w-full max-w-full border p-6 lg:p-8 rounded-2xl bg-pink-100 border-pink-600">
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-pink-600 focus:ring-2 focus:ring-pink-700 focus:ring-opacity-50"></textarea>
                                                </div>
                                                {{-- Notes --}}
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <div class="flex flex-row gap-4">
                                                        ...
                                                        <div class="flex flex-col w-1/2">
                                                            <input type="time" name="service_start_time"
                                                                ...
                                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-pink-600 focus:ring-2 focus:ring-pink-700 focus:ring-opacity-50 timepicker" />
                                                        </div>
                                                    </div>
                                                </div>
