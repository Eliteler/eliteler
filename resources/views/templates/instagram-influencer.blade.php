            ...
            @if ($business_card_details->password == null || Session::get('password_protected') == true)
                ...
                @if ($business_card_details != null)
                    <div class="bg-white lg:rounded-2xl shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden relative">
                        ...
                        <div id="content-screen" class="relative -mt-0.5 pb-28 lg:pb-6">
                            <!-- Profile Info -->
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 px-6 lg:px-8">
                                            @foreach ($feature_details as $feature)
                                                ...
                                                @endphp
                                                @if (!in_array($feature->type, ['instagram', 'threads', 'email', 'address', 'map', 'iframe', 'youtube', 'text']))
                                                    <!-- {{ $feature->label }} -->
                                        ...
                                        <div
                                            ...
                                            <div class="flex flex-col mb-4">
                                                ...
                                                <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300"></textarea>
                                            </div>
                                            {{-- Notes --}}
                                            <div class="flex flex-col mb-4">
                                                ...
                                                <div class="flex flex-row gap-4">
                                                    ...
                                                    <div class="flex flex-col w-1/2">
                                                        <input type="time" name="service_start_time"
                                                            ...
                                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-300 timepicker" />
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="pb-1 px-6 lg:px-8">
                                    <div
                                        ...
                                        <div class="mt-2 text-gray-500">
                                            {{ __('Copyright') }} &copy;
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-gray-700" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-gray-700">{{ $__cr_text }}</span>@endif<span id="year"></span>{{ __('. All Rights Reserved.') }}
                                        </div>
                                    </div>
                                </div>
                            @else
