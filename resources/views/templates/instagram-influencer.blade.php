                    ...
                    <div class="relative -mt-0.5 pb-28 lg:pb-6">
                        ...
                        <div class="relative z-20 bg-transparent pt-8 flex px-6 lg:px-8">
                            ...
                            <div
                                ...
                                {{-- Name --}}
                                <h1 class="text-4xl lg:text-5xl font-extrabold head">@if(!empty($business_card_details->title2))
                            ...
                            <div class="pb-1 px-6 lg:px-8">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-gray-700" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                        ...
                        @else
                            <div class="pb-1 px-6 lg:px-8">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Made with') }}
                                        <a class="text-gray-700" href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
                            </div>
