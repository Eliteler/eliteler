...
<body class="bg-gray-50 min-h-screen"
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content" class="container max-w-2xl mx-auto">
            {{-- Start Check password protected --}}
            @if ($business_card_details->password == null || Session::get('password_protected') == true)
                {{-- Check business details --}}
                @if ($business_card_details != null)
                    <div class="bg-[#000000] shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden relative">
                        {{-- Index Screen --}}
                        @if ($introScreen != null)
...
<h1 class="lg:text-4xl text-3xl font-medium text-white head text-start" style="margin-bottom: 0px; padding-bottom: 0px;">{{ $business_card_details->title2 }}</h1>
@endif
@if(!empty($business_card_details->subtitle2))
<p class="text-gray-400 font-bold mt-2 text-md text-start" style="margin-bottom: 5px; padding-bottom: 0px;">{{ $business_card_details->subtitle2 }}</p>
@endif
<h1 class="lg:text-4xl text-3xl font-medium text-white head text-start">{{ $business_card_details->title }}</h1>
                                        {{-- Job Title --}}
                                        <p class="text-gray-400 font-bold mt-2 text-md text-start">{{ $card_details->sub_title }}</p>
                                        {{-- About --}}
                                ...
                                @if (!empty($feature_details) && count($feature_details) > 0)
                                    @php
                                        // Excluded types
                                        $excludedTypes = ['tel', 'address', 'map', 'iframe', 'youtube', 'text', 'wa'];
                                        ...
                                        <div class="relative border-b border-gray-600 pb-6">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-6">
                                                @foreach ($feature_details as $feature)
                                                    ...
                                                    @endphp
                                                    @if (!in_array($feature->type, ['tel', 'map', 'iframe', 'youtube', 'address', 'wa', 'text']))
                                                        <!-- {{ $feature->label }} -->
                                        ...
                                        <div class="grid grid-cols-1 gap-4 items-center px-6">
                                            ...
                                            @foreach ($feature_details as $feature)
                                                @if ($feature->type == 'iframe')
                                                    <div class="overflow-hidden rounded-2xl">
                                                        <iframe referrerpolicy="strict-origin-when-cross-origin"
                                                            width="100%" height="270" src="{{ $feature->content }}"
                                                            title="{{ $feature->label }}" frameborder="0"
                                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                                            allowfullscreen></iframe>
                                                        {{-- Add Iframe title --}}
                                ...
                                @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                                    @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                        <div class="relative px-6 border-b border-gray-600 pb-6">
                                            <img src="{{ asset('img/templates/youtuber/3.png') }}" alt=""
                                                class="w-20 absolute top-5 -left-5" />
                                            <h2
                                                class="text-3xl lg:text-4xl font-medium text-gray-50 pt-8 pb-14 text-center relative head">
                                            ...
                                            <div
                                                ...
                                                <div class="flex flex-col lg:flex-row lg:gap-4 mb-4">
                                                    ...
                                                    <div class="flex flex-col w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        <label for="customer_name"
                                                            class="text-white font-medium mb-2">{{ __('Name') }}</label>
                                                        <input type="text" name="customer_name" id="customer_name"
                                                            placeholder="{{ __('Your Name') }}"
                                                            class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-600" />
                                                    </div>
                                                    {{-- Email --}}
                                                    <div class="flex flex-col w-full lg:w-1/2">
                                                        <label for="customer_email"
                                                            class="text-white font-medium mb-2">{{ __('Email') }}</label>
                                                ...
                                                <div class="flex flex-col lg:flex-row lg:gap-4 mb-4">
                                                    ...
                                                    <div class="flex flex-col w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        <label for="customer_phone"
                                                            class="text-white font-medium mb-2">{{ __('Mobile Number') }}</label>
                                                    ...
                                                    <div class="flex flex-col w-full lg:w-1/2">
                                                        <label for="no_of_persons"
                                                            class="text-white font-medium mb-2">{{ __('No. of Person(s)') }}</label>
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    <label for="customer_address"
                                                        class="text-white font-medium mb-2">{{ __('Address') }}</label>
                                                    <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-600"></textarea>
                                                </div>
                                                {{-- Notes --}}
                                                <div class="flex flex-col mb-4">
                                                    <label for="customer_message"
                                                        class="text-white font-medium mb-2">{{ __('Notes') }}</label>
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <label for="service_start_date"
                                                        class="text-white font-medium mb-2">{{ __('Service Start DateTime') }}</label>
                                                    <div class="flex flex-row gap-4">
                                                        ...
                                                        <div class="flex flex-col w-1/2">
                                                            <input type="time" name="service_start_time"
                                                                ...
                                                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-600 timepicker" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <label for="service_end_date"
                                                        class="text-white font-medium mb-2">{{ __('Service End DateTime') }}</label>
                                                    <div class="flex flex-row gap-4">
                                                        <div class="flex flex-col w-1/2">
                                ...
                                @if (is_dir(base_path('plugins/GoogleWallet')))
                                    @if (isset($plan_details['google_wallet']) &&
                                        ...
                                        <div class="relative border-b border-gray-600 p-6">
                                            <h2
                                                class="text-3xl lg:text-4xl font-medium text-gray-50 pt-8 pb-14 text-center relative head">
                                                <div
                                                    class="absolute bottom-8 left-1/2 h-1.5 w-16 bg-gray-500 -translate-x-1/2">
                                            ...
                                            <div
                                                class="w-full max-w-full border p-6 rounded-2xl bg-[#282828] text-white border border-gray-500 relative z-10">
                                                ...
                                                @if ($google_wallet_details->wallet_link != null)
                                                    <div class="flex justify-center mt-6">
                                                        <a href="{{ $google_wallet_details->wallet_link }}"
                                                            class="w-full lg:w-1/2" target="_blank"
                                    ...
                                    <div class="px-4">
                                        <div
                                            ...
                                            <div class="mt-2 text-gray-400">
                                                {{ __('Copyright') }} &copy;
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-white" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-white">{{ $__cr_text }}</span>@endif<span id="year"></span>{{ __('. All Rights Reserved.') }}
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="px-4">
                                        <div
                                            ...
                                            <div class="mt-2 text-gray-400">
                                                {{ __('Made with') }}
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-white" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-white">{{ $__cr_text }}</span>@endif
                        ...
                        <div x-show="showModal" class="fixed inset-0 flex items-center justify-center z-50 p-3">
                            <div class="bg-white p-6 w-96 max-w-full shadow-lg transform transition-all duration-300 rounded-2xl"
                                ...
                                <div class="mt-6 space-y-4">
                                    <form
                                        action="{{ config('app.url') }}/check-password/{{ $business_card_details->card_id }}"
                                        method="post">
                                        @csrf
