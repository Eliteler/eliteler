...
<h1 class="lg:text-4xl text-3xl font-medium text-white head text-start">{{ $business_card_details->title }}</h1>
                                ...
                                @if (!empty($feature_details) && count($feature_details) > 0)
                                    @php
                                        // Excluded types
                                        $excludedTypes = ['tel', 'address', 'map', 'iframe', 'youtube', 'wa'];
                                    ...
                                    <div class="px-4">
                                        <div
                                            ...
                                            <div class="mt-2 text-gray-400">
                                                {{ __('Copyright') }} &copy;
                                                <a class="text-white" href="{{ !empty($business_card_details->copyright) ? (str_starts_with($business_card_details->copyright, 'http') ? $business_card_details->copyright : 'https://'.$business_card_details->copyright) : env('APP_URL') }}" target="_blank" rel="noopener noreferrer">
