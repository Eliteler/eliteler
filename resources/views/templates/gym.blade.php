                                    ...
                                    <div class="pb-1">
                                        <div
                                            ...
                                            <div class="mt-2 text-black">
                                                {{ __('Copyright') }} &copy;
                                                <a class="text-black" href="{{ !empty($business_card_details->copyright) ? (str_starts_with($business_card_details->copyright, 'http') ? $business_card_details->copyright : 'https://'.$business_card_details->copyright) : env('APP_URL') }}" target="_blank" rel="noopener noreferrer">
