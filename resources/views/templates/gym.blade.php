...
<body class="bg-[#FDFDFD] min-h-screen"
    ...
    <div id="smooth-wrapper">
        <div d="smooth-content" class="container max-w-2xl mx-auto">
                                        ...
                                        @if ($plan_details['appointment'] == 1)
                                            @if ($appointment_slots != null)
                                                <div class="flex items-center mt-14 mb-8">
                                                    ...
                                                    <span
                                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __(json_decode($appointment_slots, true)['title']) }}</span>
                                                </div>
                                    ...
                                    @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                        <div class="relative">
                                            <div class="flex items-center mt-16 mb-8">
                                                    <hr class="flex-grow border-[7px] border-gray-800 rtl:ml-6 ltr:mr-6">
                                                    <span
                                                        class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __($service_booking_details->title) }}</span>
                                                </div>
                                            ...
                                            <div class="w-full max-w-full">
                                                ...
                                                <div class="flex flex-col lg:flex-row lg:gap-4 mb-4">
                                                    ...
                                                    <div class="flex flex-col w-full lg:w-1/2 mb-4 lg:mb-0">
                                                        ...
                                                        <input type="text" name="customer_name" id="customer_name"
                                                            ...
                                                            class="w-full px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#121212] focus:ring-opacity-80" />
                                                    </div>
                                                    {{-- Email --}}
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                        class="w-full px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#121212] focus:ring-opacity-80"></textarea>
                                                </div>
                                                {{-- Notes --}}
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <div class="flex flex-row gap-4">
                                                        ...
                                                        <div class="flex flex-col w-1/2">
                                                            <input type="time" name="service_start_time"
                                                                ...
                                                                class="w-full px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#121212] focus:ring-opacity-80 timepicker" />
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    @if (isset($plan_details['google_wallet']) && $plan_details['google_wallet'] == 1 && $business_card_details->is_google_wallet_hidden == 0)
                                        <div class="relative">
                                            <div class="flex items-center mt-16 mb-8">
                                                <hr class="flex-grow border-[7px] border-gray-800 rtl:ml-6 ltr:mr-6">
                                                <span
                                                    class="text-3xl lg:text-4xl font-medium text-[#121212] head uppercase">{{ __('Google Wallet') }}</span>
                                            </div>
                                    ...
                                    <div class="pb-1">
                                        <div
                                            ...
                                            <div class="mt-2 text-black">
                                                {{ __('Copyright') }} &copy;
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-black" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-black">{{ $__cr_text }}</span>@endif<span id="year"></span>{{ __('. All Rights Reserved.') }}
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="pb-1">
                                        <div
                                            ...
                                            <div class="mt-2 text-black">
                                                {{ __('Made with') }}
                                                @php $__cr = $business_card_details->copyright ?? ''; $__cr_is_domain = !empty($__cr) && (str_starts_with($__cr, 'http') || str_contains($__cr, '.')); $__cr_url = $__cr_is_domain ? (str_starts_with($__cr, 'http') ? $__cr : 'https://'.$__cr) : (!empty($__cr) ? null : env('APP_URL')); $__cr_text = !empty($__cr) ? $__cr : parse_url(config('app.url'), PHP_URL_HOST); @endphp @if($__cr_url)<a class="text-black" href="{{ $__cr_url }}" target="_blank" rel="noopener noreferrer">{{ $__cr_text }}</a>@else<span class="text-black">{{ $__cr_text }}</span>@endif
