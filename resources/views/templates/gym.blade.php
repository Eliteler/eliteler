                    ...
                    <div class="px-4 lg:px-8 -mt-0.5 pb-28 lg:pb-8">
                        ...
                        <div class="relative z-20 bg-transparent my-4 lg:my-8 flex">
                            ...
                            <div class="flex flex-col justify-start items-start ml-6 lg:ml:8 z-20">
                                {{-- Name --}}
                                <h1 class="text-xl lg:text-4xl font-extrabold head">@if(!empty($business_card_details->title2))
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-black">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-black" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                        ...
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-black">
                                        {{ __('Made with') }}
                                        <a class="text-black" href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
                            </div>
