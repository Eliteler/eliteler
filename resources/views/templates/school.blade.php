...
<h1 class="lg:text-4xl text-3xl font-medium text-[#121212] head tracking-tighter" style="margin-bottom: 0px; padding-bottom: 0px;">{{ $business_card_details->title2 }}</h1>
@endif
@if(!empty($business_card_details->subtitle2))
<p class="text-teal-500 font-bold mt-2 text-md" style="margin-bottom: 5px; padding-bottom: 0px;">{{ $business_card_details->subtitle2 }}</p>
@endif
<h1 class="lg:text-4xl text-3xl font-medium text-[#121212] head tracking-tighter">{{ $business_card_details->title }}</h1>
                                        {{-- Job Title --}}
                                        <p class="text-teal-500 font-bold mt-2 text-md">{{ $card_details->sub_title }}</p>
                                        {{-- About --}}
                                ...
                                @if (count($feature_details) > 0)
                                    <div class="flex justify-center gap-4 mt-6 relative">
                                        <img src="{{ asset('img/templates/school/1.png') }}" alt=""
                                            class="lg:w-32 w-28 absolute lg:-top-[25px] -top-3 -right-6 z-0" />
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                                @foreach ($feature_details as $feature)
                                                    ...
                                                    @endphp
                                                    @if (!in_array($feature->type, ['tel', 'address', 'map', 'iframe', 'youtube', 'text']))
                                                        <!-- {{ $feature->label }} -->
                                                    ...
                                                    <div class="flex flex-row gap-4">
                                                        ...
                                                        <div class="flex flex-col w-1/2">
                                                            <input type="time" name="service_start_time"
                                                                ...
                                                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 timepicker" />
                                                        </div>
                                                    </div>
                                                </div>
