...
<p class="text-pink-700 text-base font-bold mt-1 text-md text-start" style="margin-bottom: 5px; padding-bottom: 0px;">{{ $business_card_details->subtitle2 }}</p>
@endif
<h1 class="lg:text-5xl text-3xl font-medium text-gray-900 head text-start">{{ $business_card_details->title }}</h1>
                                        {{-- Job Title --}}
                                        <p class="text-pink-700 text-base font-bold mt-1 text-md text-start">{{ $card_details->sub_title }}</p>
                                        {{-- About --}}
                                            ...
                                            <div class="shadow-[0_0_4px_rgba(0,0,0,0.1)] border border-pink-300 bg-cover bg-center overflow-hidden border rounded-2xl p-6 relative"
                                                ...
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <textarea name="customer_address" id="customer_address" placeholder="{{ __('Your Address') }}" rows="3"
                                                        class="w-full px-4 py-3 text-gray-800 bg-white border border-gray-300 rounded-xl focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-600 focus:ring-opacity-50"></textarea>
                                                </div>
                                                {{-- Notes --}}
                                                <div class="flex flex-col mb-4">
                                                    ...
                                                    <div class="flex flex-row gap-4">
                                                        ...
                                                        <div class="flex flex-col w-1/2">
                                                            <input type="time" name="service_start_time"
                                                                ...
                                                                class="w-full px-4 py-3 text-gray-800 bg-white border border-gray-300 rounded-xl focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-600 focus:ring-opacity-50 timepicker" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex flex-col">
                                                    <button onclick="submitServiceBooking()"
                                                        class="w-full px-4 py-3 bg-pink-600 text-white text-xl font-medium focus:outline-none rounded-xl">
                                                        {{ __('Submit') }}
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                @if (is_dir(base_path('plugins/GoogleWallet')))
                                    @if (isset($plan_details['google_wallet']) && $plan_details['google_wallet'] == 1 && $business_card_details->is_google_wallet_hidden == 0)
                                        <div class="relative">
                                            ...
                                            <div class="w-full max-w-full border p-6 rounded-2xl bg-cover bg-center border-pink-300 relative"
                                                style="background-image: url('{{ asset('img/templates/flower-shop/card-bg.png') }}')">
            ...
            <div id="scanModal"
                ...
                <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 border-pink-300 bg-pink-100 qr-modal-overlay"
                    ...
                    <!-- Submit Button -->
                    <div class="flex justify-center">
                        <button onclick="downloadQr('{{ config('app.url') . route('dynamic.card', $business_card_details->card_id, false) }}', 500, '{{ addslashes($business_card_details->title) }}')"
