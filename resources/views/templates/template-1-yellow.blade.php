                    ...
                    <div class="flex flex-wrap template-1 -m-2">
                        <div class="w-full lg:w-1/2 bg-white p-4">
                            ...
                            <div class="relative {{ $business_card_details->cover_type == 'photo' ? 'py-2' : '' }}">
                                <div class="relative {{ $business_card_details->cover_type == 'photo' ? '' : '' }} rounded overflow-hidden">
                                    @if ($business_card_details->cover_type == 'photo')
                                        <div class="relative">
                                            ...
                                            <!-- Profile image positioned at bottom: -3.5rem -->
                                            <div class="absolute left-1/2 -translate-x-1/2 -bottom-14">
                                                <img class="w-28 h-28 rounded-full object-cover border-4 border-white shadow"
...
<h2 class="font-medium">{{ $business_card_details->title }}</h2>
                            ...
                            @if (isset($plan_details['service_booking']) && $plan_details['service_booking'] == 1)
                                @if (isset($service_booking_details) && $service_booking_details->service_booking == 1)
                                    @include('templates.includes.service-booking', [
                                        ...
                                        'btn_style' => 'mb-2 w-full py-4 bg-yellow-500 hover:bg-yellow-600 text-sm rounded font-bold text-gray-50 transition duration-200',
                                    ])
                                @endif
                            @endif
                            {{-- End Service Booking --}}
                            ...
                            @if (is_dir(base_path('plugins/GoogleWallet')))
                                @if (isset($plan_details['google_wallet']) && $plan_details['google_wallet'] == 1 && $business_card_details->is_google_wallet_hidden == 0)
                                    <div class="py-5">
                                        <div class="mb-5">
                                            <h2 class="w-full md:w-auto text-2xl font-bold">
                                                    {{ __('Google Wallet') }}
                                            </h2>
                                        </div>
