...
<body class="bg-[#F5F5F4] min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto relative">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
            {{-- Check business details --}}
            @if ($business_card_details != null)
                <div class="bg-white shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden">
                    ...
                    <div class="relative px-6 -mt-0.5 pb-32 lg:p-6">
                        ...
                        <div class="text-center mt-4 relative -mx-6">
                            ...
                            <div class="relative z-10">
                                {{-- Name --}}
                                <h1 class="lg:text-5xl text-3xl font-medium text-[#121212] custom-head">@if(!empty($business_card_details->title2))
...
@endif
                                ...
                                {{-- Job Title --}}
                                <p class="text-purple-800 font-bold mt-2 text-md">
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-purple-800" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                        ...
                        @else
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Made with') }}
                                        <a class="text-purple-800" href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                                        <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                    </div>
                                </div>
                            </div>
