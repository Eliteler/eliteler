                    ...
                    <div class="-mt-0.5 pb-32 lg:pb-6 px-6">
                        ...
                        <div class="text-center mt-4 relative flex">
                            ...
                            <div class="relative z-10 flex flex-col w-9/12 ltr:ml-6 rtl:mr-6">
                                {{-- Name --}}
                                <h1 class="lg:text-4xl text-3xl font-medium text-black head text-start">@if(!empty($business_card_details->title2))
...
@endif
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div
                                ...
                                <div class="mt-2 text-gray-600">
                                    {{ __('Copyright') }} &copy;
                                    <a class="text-orange-400" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                        ...
                        @else
                            <div
                                ...
                                <div class="mt-2 text-gray-600">
                                    {{ __('Made with') }}
                                    <a class="text-orange-400" href="{{ env('APP_URL') }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                                    <span id="year"></span>{{ __('. All Rights Reserved.') }}
                                </div>
                            </div>
                        @endif
