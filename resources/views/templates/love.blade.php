                    ...
                    <div class="-mt-0.5 py-32 lg:pb-6 px-6">
                        ...
                        <div class="relative z-20 bg-transparent flex px-4">
                            ...
                            <div
                                ...
                                {{-- Name --}}
                                <h1 class="text-3xl lg:text-4xl font-bold head text-white">@if(!empty($business_card_details->title2))
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div
                                ...
                                <div class="mt-2 text-gray-200">
                                    {{ __('Copyright') }} &copy;
                                    <a class="text-pink-600" href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
