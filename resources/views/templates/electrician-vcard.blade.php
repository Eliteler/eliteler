...
@endif
                ...
                @if ($socialFeatures->isNotEmpty())
                    <div class="section gsap-fade">
                        <i class="fas fa-plug decor-icon anim-flicker" style="font-size:70px;left:10px;top:40px"></i>
                        <div class="section-header">
                ...
                @if (count($service_details) > 0)
                    <div class="section gsap-fade">
                        <i class="fas fa-bolt decor-icon anim-flicker" style="font-size:90px;right:10px;top:10px"></i>
                        <div class="section-header">
                ...
                @if (count($galleries_details) > 0)
                    <div class="section gsap-fade">
                        <i class="fas fa-tools decor-icon anim-gear" style="font-size:60px;left:15px;top:-5px"></i>
                        <div class="section-header">
                                                ...
                                                <div>
                                                    ...
                                                    @if ($t->review_subtext)
                                                        <p
                                                            ...
                                                            {{ $t->review_subtext }}</p>
                                                    @endif
                                                    <div style="color:var(--primary);font-size:12px;margin-top:3px">
                                                        ★★★★★
                                                    </div>
                                                </div>
                                            </div>
                ...
                @if ($plan_details['contact_form'] == 1 && $business_card_details->enquiry_email != null)
                    <div class="section gsap-fade" id="contact-section">
                        ...
                        @endif
                        <form class="tech-card" action="{{ config('app.url') }}/sent-enquiry" method="POST">
                            @csrf
                ...
                <div class="section branding-footer">
                    @if ($plan_details['hide_branding'] == 1)
                        {{ __('Copyright') }} &copy; <a
                            href="{{ url()->current() }}">{{ !empty($business_card_details->copyright) ? $business_card_details->copyright : parse_url(config('app.url'), PHP_URL_HOST) }}</a>
    ...
    @if (
        ...
        @include('templates.includes.vcard.electrician.information_popup_modal')
    @endif
